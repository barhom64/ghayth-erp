...
|------|-------|------------------|
| Pages using FormShell directly | **157** | ✅ `grep -lr FormShell artifacts/ghayth-erp/src/pages` |
| Pages using InlineEditForm (FormShell-backed) | **22** | ✅ `grep -lr InlineEditForm artifacts/ghayth-erp/src/pages` |
| **Total pages on FormShell (direct + indirect)** | **179** | — |
