...
|------|-------|------------------|
| Pages using FormShell directly | **156** | ✅ `grep -lr FormShell artifacts/ghayth-erp/src/pages` |
| Pages using InlineEditForm (FormShell-backed) | **22** | ✅ `grep -lr InlineEditForm artifacts/ghayth-erp/src/pages` |
| **Total pages on FormShell (direct + indirect)** | **178** | — |
| Shared components using FormShell | **7** | ✅ `grep -lr FormShell artifacts/ghayth-erp/src/components` |
