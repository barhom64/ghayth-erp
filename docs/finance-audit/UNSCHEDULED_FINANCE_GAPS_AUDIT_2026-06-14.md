...
> ✅ فُتحت (7): **#2277** (خلط الحسابات) · **#2278** (FX) · **#2280** (تسوية ضريبية) · **#2295** (متعددة العملات) · **#2296** (موازنة الشراء) · **#2301** (ابتلاع GL في umrah) · **#2303** (عنقود الرواتب) — كلها مربوطة بالأم #2230.
