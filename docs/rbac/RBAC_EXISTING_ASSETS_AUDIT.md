...
> **تحديث الحالة (2026-05-30):** **RBAC-001** (تسجيل الدور بالتدقيق) و**RBAC-002** (الإنشاء السريع) و**RBAC-004** (Effective Viewer + Explainer) أصبحت **مُغلقة ومدموجة** (PRs #1424/#1446/#1450). RBAC-003 مُحتوى (مُجَسَّر مسبقًا). تُقرأ الخطورات أدناه (الحالة وقت الجرد) مقترنةً بـ `docs/GHAITH_FOUNDATION_IMPLEMENTATION_STATUS.md`.
