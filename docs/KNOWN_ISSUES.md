...
- [`audit/archive/SESSION_AUDIT_2026-05-23.md`](audit/archive/SESSION_AUDIT_2026-05-23.md) — autonomous 11-round audit (archived). 27 fixes merged, ~14 false positives rejected (with rationale), 25+ areas verified clean. Closes 3 HIGH-severity security gaps (PBX HMAC, outbound SSRF, refresh-token reuse) and 2 data-integrity races (discipline memo, GRN ref). Findings are NOT considered closed until merge + runtime verification + production parity + regression confirmation. See § 7 for residual risk and § 8 for hardening roadmap.
- [`audit/EXECUTIVE_INVENTORY_REPORT.md`](audit/EXECUTIVE_INVENTORY_REPORT.md) — earlier executive inventory.
- [`audit/archive/RESCAN_2026-05-22-v3.md`](audit/archive/RESCAN_2026-05-22-v3.md) — pre-session rescan baseline (archived).
