...
const FILES = [
  "artifacts/api-server/src/routes/moduleDashboards.ts",
  "replit.md",
];
const MSG = "fix(moduleDashboards): drop ls.deletedAt (col missing); qualify ambiguous status in payments+tasks; doc API path canonicals + cookie auth";
