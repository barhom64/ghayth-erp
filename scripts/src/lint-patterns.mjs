...
const RULES = [
  ...
  },
  {
    ...
    // locks the current count (18 across 12 files at #1715 wave time) so no
    // NEW in-page prefix logic is added; each migration of a page to
    // finance-account-usage should drop the baseline by the same number.
