...
/**
 * U-07 Phase 17 — umrah-entities.ts split smoke (analytical reports batch 2).
 *
 * Scope:
 *   - Carves the final 6 read-only analytical-report routes into the EXISTING
 *     umrah-reports.ts sub-router:
 *       GET /finance-hygiene
 *       GET /reports/nusk-invoices-summary
 *       GET /reports/umrah-transport
 *       GET /reports/umrah-costs
 *       GET /reports/sales-invoices-summary
 *       GET /reports/import-errors-summary
 ...
 *   - No ledger touch — all 6 routes are read-only SELECT aggregates.
 *
...
// ─────────────────────────────────────────────────────────────────────────────
// §A — Reports file still a valid, already-mounted sub-router
// ─────────────────────────────────────────────────────────────────────────────
describe("U-07 Phase 17 §A — umrah-reports.ts stays a valid sub-router", () => {
...
// ─────────────────────────────────────────────────────────────────────────────
describe("U-07 Phase 17 §B — moved reports are read-only (no ledger leak)", () => {
...
// ─────────────────────────────────────────────────────────────────────────────
// §C — All 6 routes live in the reports file now
// ─────────────────────────────────────────────────────────────────────────────
describe("U-07 Phase 17 §C — moved routes are present in umrah-reports.ts", () => {
...
// ─────────────────────────────────────────────────────────────────────────────
describe("U-07 Phase 17 §D — parent no longer declares the moved routes", () => {
  for (const [method, route] of MOVED) {
...
// ─────────────────────────────────────────────────────────────────────────────
describe("U-07 Phase 17 §E — parent shrunk below the pre-split line count", () => {
  it("parent file has fewer than 1500 lines (was ~2141 before this carve, ~1394 after)", () => {
