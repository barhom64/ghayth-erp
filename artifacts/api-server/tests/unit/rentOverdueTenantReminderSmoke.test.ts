...
const MIG = readFileSync(
  join(import.meta.dirname!, "..", "..", "src", "migrations", "420_seed_rent_overdue_day1_template.sql"),
  "utf8",
);
...
describe("Rent overdue → tenant SMS reminder on day 1 (spec ملف 05)", () => {
  ...
  it("migration 420 seeds property.rent.overdue.day1 in sms + email + whatsapp (ar + en)", () => {
