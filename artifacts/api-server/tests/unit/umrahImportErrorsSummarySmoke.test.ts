...
describe("Reports Hub — tile registered", () => {
  it("the hub catalog lists the import-errors-summary tile under تشغيلية", () => {
    expect(HUB).toContain('href: "/umrah/reports/import-errors-summary"');
    expect(HUB).toContain("ملخّص أخطاء الاستيراد");
  });
});
