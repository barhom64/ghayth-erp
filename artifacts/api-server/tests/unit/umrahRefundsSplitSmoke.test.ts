...
/**
 * U-07 Phase 3 — umrah-entities.ts split, refund-requests CRUD carve-out.
 *
 * Mirrors the Phase 2 (families) smoke. Pins:
 *   - The new sub-router file exists + is a valid Router export.
 *   - The parent mounts the sub-router (so /umrah/refund-requests/... still resolves).
 *   - The 6 refund routes ALL live in the child.
...
// ─────────────────────────────────────────────────────────────────────────────
describe("U-07 Phase 3 §C — all 6 refund routes are present in the child", () => {
...
// ─────────────────────────────────────────────────────────────────────────────
describe("U-07 Phase 3 §E — parent shrank from the pre-carve line count", () => {
  it("parent file has fewer than 5900 lines (pre-Phase-3 it was 6026+)", () => {
