...
const MANUAL_SCOPE_ALLOWLIST = new Set<string>([
  ...
  // fleet-driver-intelligence.ts: #1812 follow-up — per-driver stats.
  // Single-driver lookup keyed on (companyId, driverId); fleet leaderboard
  // is a list scoped on (companyId). buildScopedWhere has no branch cascade.
  "fleet-driver-intelligence.ts",
