...
router.use("/hr", requireModule("hr"), requireGuards("financial"), hrRouter);
...
router.use("/projects", requireModule("operations"), requireGuards("financial"), projectsRouter);
router.use("/support", requireModule("support"), requireGuards("financial"), supportRouter);
