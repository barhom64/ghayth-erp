...
router.post("/", authorize({ feature: "tasks", action: "create" }), async (req, res) => {
  try {
    ...
    // subsequent elements are 'member'. Errors here are swallowed only
    // when they're duplicate-row races; everything else propagates so
    // the client sees a real validation error.
