    ...
    try {
      ...
      const section3: PlanSection = {
        ...
        items: [
          ...
          { key: "stt", label: "Speech-to-text", status: ifTable("pbx_call_transcripts", "partial"), evidence: "Queue + worker tick ready; STT_NOT_CONFIGURED sentinel until vendor wired in lib/pbxControl.runPendingTranscription", externalBlocker: "STT vendor (Whisper/Azure Speech)" },
