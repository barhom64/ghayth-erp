...
// U-07 Phase 4 — hotels + room-blocks + room-allocations moved to a
// dedicated sub-router so the parent file shrinks further. Paths still
// resolve at /umrah/hotels, /umrah/room-blocks, /umrah/room-allocations.
