...
export const DOMAIN_REGISTRY: DomainDefinition[] = [
  {
    ...
    engines: ["disciplineEngine", "lifecycleEngine", "workflowEngine", "obligationsEngine"],
  ...
  },
  {
    ...
    engines: ["lifecycleEngine", "obligationsEngine", "rulesEngine"],
  ...
  },
  {
    ...
    engines: ["lifecycleEngine", "obligationsEngine"],
