...
export const DOMAIN_REGISTRY: DomainDefinition[] = [
  {
    ...
    tables: [
      ...
      "employee_transfers", "payroll_runs", "payroll_lines", "hr_inquiry_memos",
    ...
    lifecycleEntities: ["hr_leave_requests", "hr_exit_requests", "hr_inquiry_memos", "employee_transfers"],
    eventPrefix: "hr.",
  ...
  },
  {
    ...
    engines: ["umrahEngine", "umrahInvoicingEngine", "umrahCommissionEngine", "umrahImportEngine", "obligationsEngine", "journeyEngine"],
    permissions: ["umrah:read", "umrah:write"],
    lifecycleEntities: ["umrah_sales_invoices"],
    eventPrefix: "umrah.",
    cronJobs: ["season_auto_close", "commission_auto_calculate", "umrah_daily_absconder_check", "umrah_overdue_invoice_escalation", "umrah_weekly_agent_performance"],
    glIntegration: true,
  ...
  },
  {
    ...
    engines: ["supportEngine", "obligationsEngine"],
  ...
  },
  {
    ...
    engines: ["projectsEngine", "lifecycleEngine"],
