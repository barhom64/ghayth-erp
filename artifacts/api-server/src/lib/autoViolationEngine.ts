...
//
// HR-013: هذا الملف هو الكاتب الأساسي لجدول `employee_violations` (حادث
// مُسجَّل). إنشاء «محاضر التحقيق» المرتبطة (`hr_inquiry_memos`) يحدث عبر
// disciplineEngine، والربط بينهما يُحفَظ في
// employee_violations."inquiryMemoId" (FK في هجرة 195).
//
// الأنواع المدعومة:
