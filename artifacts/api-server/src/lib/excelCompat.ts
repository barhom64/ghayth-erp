...
// (genericImportEngine.ts, umrahImportEngine.ts). Replaces the former
// `xlsx@0.18.5` dependency which carried unfixed Prototype-Pollution
// + ReDoS advisories (Task #269).
//
