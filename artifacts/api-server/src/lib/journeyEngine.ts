...
// ─────────────────────────────────────────────────────────────────────────────
// خريطة المفاهيم (متمايز — ليس تكرارًا · قاموس المفاهيم §3): journeyEngine = رحلات
// تشغيلية متعددة الخطوات عبر المسارات. ليس lifecycleEngine (آلة الحالات العامة) ولا
// employeeLifecycleEngine (سياسة موظف HR). مفهوم مستقل.
// ─────────────────────────────────────────────────────────────────────────────
//
