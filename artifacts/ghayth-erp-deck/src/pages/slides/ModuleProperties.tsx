    ...
    <div className="relative w-screen h-screen overflow-hidden bg-bg px-[6vw] py-[6vh]" dir="rtl">
      ...
      <div className="absolute top-[42vh] right-[6vw] left-[6vw] grid grid-cols-2 gap-x-[2vw] gap-y-[2vh]">
        <div className="bg-surface rounded-xl p-[1.6vw] border-r-4 border-accent">
          <div className="font-display text-primary text-[1.6vw] font-bold">العقارات والوحدات</div>
          <div className="font-body text-muted text-[1.05vw] mt-[0.6vh] leading-snug">سجل عقارات ووحدات، صور ووثائق، حالة الإشغال والشواغر لحظياً.</div>
        </div>
        <div className="bg-surface rounded-xl p-[1.6vw] border-r-4 border-primary">
          <div className="font-display text-primary text-[1.6vw] font-bold">عقود الإيجار</div>
          <div className="font-body text-muted text-[1.05vw] mt-[0.6vh] leading-snug">إنشاء، تجديد، إنذار وإنهاء، جداول دفعات وفهرسة سنوية تلقائية.</div>
        </div>
        <div className="bg-surface rounded-xl p-[1.6vw] border-r-4 border-accent">
          <div className="font-display text-primary text-[1.6vw] font-bold">التحصيل والمتأخرات</div>
          <div className="font-body text-muted text-[1.05vw] mt-[0.6vh] leading-snug">فواتير دورية، تذكيرات للمستأجرين، أعمار ديون وربط محاسبي.</div>
        </div>
        <div className="bg-surface rounded-xl p-[1.6vw] border-r-4 border-primary">
          <div className="font-display text-primary text-[1.6vw] font-bold">الصيانة والبلاغات</div>
          <div className="font-body text-muted text-[1.05vw] mt-[0.6vh] leading-snug">طلبات صيانة من البوابة، إسناد للفنيين، تكلفة وأثر على العائد.</div>
        </div>
      </div>
