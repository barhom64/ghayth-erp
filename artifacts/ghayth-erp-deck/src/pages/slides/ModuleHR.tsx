    ...
    <div className="relative w-screen h-screen overflow-hidden bg-bg px-[6vw] py-[6vh]" dir="rtl">
      ...
      <div className="absolute top-[42vh] right-[6vw] left-[6vw] grid grid-cols-2 gap-x-[2vw] gap-y-[2vh]">
        <div className="bg-surface rounded-xl p-[1.6vw] border-r-4 border-accent">
          <div className="font-display text-primary text-[1.6vw] font-bold">ملفات الموظفين والعقود</div>
          <div className="font-body text-muted text-[1.05vw] mt-[0.6vh] leading-snug">سجل موحّد، مرفقات، تجديد تلقائي للعقود، تنبيهات الانتهاء.</div>
        </div>
        <div className="bg-surface rounded-xl p-[1.6vw] border-r-4 border-primary">
          <div className="font-display text-primary text-[1.6vw] font-bold">الرواتب والمكافآت</div>
          <div className="font-body text-muted text-[1.05vw] mt-[0.6vh] leading-snug">مسير رواتب شهري، استقطاعات، بدلات، تكامل بنكي وتقارير ضريبية.</div>
        </div>
        <div className="bg-surface rounded-xl p-[1.6vw] border-r-4 border-accent">
          <div className="font-display text-primary text-[1.6vw] font-bold">الحضور والإجازات</div>
          <div className="font-body text-muted text-[1.05vw] mt-[0.6vh] leading-snug">جداول مناوبات، أرصدة إجازات، طلبات ذاتية وموافقات هرمية.</div>
        </div>
        <div className="bg-surface rounded-xl p-[1.6vw] border-r-4 border-primary">
          <div className="font-display text-primary text-[1.6vw] font-bold">تقييم الأداء والتدريب</div>
          <div className="font-body text-muted text-[1.05vw] mt-[0.6vh] leading-snug">دورات تقييم دورية، مؤشرات أداء، خطط تدريبية وسجل كفاءات.</div>
        </div>
      </div>
