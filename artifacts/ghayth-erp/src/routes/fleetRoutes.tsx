...
const TransportDriverIntelligence = lazy(() => import("@/pages/fleet/transport-driver-intelligence"));
...
export const fleetRoutes = [
  ...
  { path: "/fleet/transport/driver-intelligence", component: TransportDriverIntelligence },
