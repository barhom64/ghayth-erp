...
import { FileText, Upload, Download, Plus, X, FileUp, Eye, List, LayoutGrid, ClipboardCheck, Printer, MessageCircle, Loader2 } from "lucide-react";
...
export function EntityDocuments({ entityType, entityId, title = "المستندات المرتبطة", viewMode = "list", canReview = false, categories, defaultCategory, quickUpload = false }: EntityDocumentsProps) {
