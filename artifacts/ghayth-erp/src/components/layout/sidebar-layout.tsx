...
import {
  ...
  BarChart2, ShieldAlert, Flag, Lock, Layers, TrendingDown,
} from "lucide-react";
  ...
  // ══════════════════════════════════════════════════════════════════════
  {
    ...
    items: [
      ...
      { label: "الحسابات والقيود", path: "/finance/accounts", icon: GitBranch, module: "finance", children: [
        ...
        { label: "حسابات فرعية", path: "/finance/subsidiary-accounts", icon: GitBranch },
        { label: "مراكز التكلفة", path: "/finance/cost-centers", icon: Layers },
        { label: "ميزان المراجعة", path: "/finance/trial-balance-comparison", icon: Scale },
        ...
        { label: "قوالب قيود (مكتبة)", path: "/finance/journal-templates", icon: Layers },
        ...
        { label: "طابور ترحيل GL", path: "/finance/gl-posting-queue", icon: Clock },
      ]},
      { label: "الفواتير والسندات", path: "/finance/invoices", icon: Receipt, module: "finance", children: [
        ...
        { label: "دفعات مقدمة من العملاء", path: "/finance/customer-advances", icon: DollarSign },
      ...
      { label: "المشتريات والموردين", path: "/finance/purchase-orders", icon: ShoppingCart, module: "finance", children: [
        ...
        { label: "طلبات الشراء", path: "/finance/purchase-requests", icon: ShoppingCart },
      ...
      { label: "النقد والذمم", path: "/finance/treasury", icon: Building, module: "finance", children: [
        ...
        { label: "مركز التسويات", path: "/finance/reconciliation-hub", icon: Scale },
        ...
        { label: "كشوف الجهات", path: "/finance/entity-statements", icon: FileText },
        { label: "مخاطر العملاء", path: "/finance/customer-risk", icon: AlertTriangle },
        { label: "إجراءات التحصيل", path: "/finance/collections", icon: Bell },
        { label: "خطابات التذكير", path: "/finance/dunning", icon: Mail },
        { label: "شطب ديون", path: "/finance/bad-debt", icon: TrendingDown },
        ...
        { label: "أسعار الصرف", path: "/finance/fx-rates", icon: ArrowLeftRight },
        { label: "إعادة تقييم العملات", path: "/finance/fx-revaluation", icon: Scale },
      ]},
      { label: "الأصول والعهد", path: "/finance/fixed-assets", icon: Building2, module: "finance", children: [
        ...
        { label: "تقرير أعمار العهد", path: "/finance/custodies/report", icon: Clock },
      ...
      { label: "الفترات والميزانية", path: "/finance/budget", icon: FileBarChart, module: "finance", children: [
        ...
        { label: "اعتماد الميزانية", path: "/finance/budget-approvals", icon: CheckSquare },
        { label: "انحرافات الميزانية", path: "/finance/budget-variance", icon: TrendingDown },
      ...
      { label: "التكاليف والتسويات", path: "/finance/project-costing", icon: FolderOpen, module: "finance", children: [
        ...
        { label: "قواعد التخصيص", path: "/finance/allocation-rules", icon: Layers },
        { label: "نتائج التخصيص", path: "/finance/allocation-results", icon: Layers },
        { label: "تغطية التخصيص", path: "/finance/allocation-coverage", icon: Layers },
        { label: "تقرير التجاوزات", path: "/finance/overrides-report", icon: AlertTriangle },
      ...
      { label: "الضرائب والتقارير", path: "/finance/tax", icon: Scale, module: "finance", children: [
        ...
        { label: "رموز الضريبة", path: "/finance/tax-codes", icon: Scale },
        { label: "فئات الاستقطاع (WHT)", path: "/finance/wht-categories", icon: Percent },
        ...
        { label: "ملخص COGS", path: "/finance/reports/cogs-summary", icon: Package },
        { label: "تقييم المخزون (تقرير)", path: "/finance/reports/inventory-valuation", icon: Package },
        { label: "دوران المخزون", path: "/finance/reports/inventory-turnover", icon: Activity },
        { label: "مخزون سالب", path: "/finance/reports/negative-stock", icon: AlertTriangle },
        { label: "تنبيهات الدفعات منتهية", path: "/finance/reports/lot-expiry-alerts", icon: AlertTriangle },
      ]},
