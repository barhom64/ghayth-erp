  ...
  // ══════════════════════════════════════════════════════════════════════
  {
    ...
    items: [
      ...
      { label: "الضرائب والتقارير", path: "/finance/tax", icon: Scale, module: "finance", children: [
        ...
        { label: "تسوية VAT", path: "/finance/vat-reconciliation", icon: Scale },
        { label: "ملخص WHT", path: "/finance/wht-summary", icon: Percent },
      ...
      { label: "صناديق الواردات", path: "/finance/approvals-inbox", icon: Bell, module: "finance", children: [
        ...
        { label: "Unmapped Lines", path: "/finance/unmapped-lines", icon: AlertTriangle },
        { label: "Posting Activity", path: "/finance/posting-activity", icon: Activity },
      ]},
