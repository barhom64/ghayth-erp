  ...
  return (
    <>
      ...
      >
        ...
        {triggerLabel || "شروط"}
        {conditionCount > 0 && (
          <Badge variant="outline" className="ms-1 h-4 px-1 text-[10px] bg-white text-blue-700">
            {conditionCount}
          </Badge>
        )}
      </Button>
          ...
          <div className="space-y-4">
            ...
            <Card>
              <CardContent className="p-3">
                <p className="text-xs font-semibold text-gray-700 mb-2">حالة السجل</p>
                <ListInput
            ...
            <Card>
              <CardContent className="p-3">
                <p className="text-xs font-semibold text-gray-700 mb-2">حدود المبلغ (تُقرأ من السجل)</p>
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    <label className="text-[10px] text-gray-500 block mb-1">الحد الأدنى</label>
                    <Input
                      type="number"
                  ...
                  <div>
                    <label className="text-[10px] text-gray-500 block mb-1">الحد الأقصى</label>
                    <Input
                      type="number"
            ...
            <Card>
              <CardContent className="p-3">
                <p className="text-xs font-semibold text-gray-700 mb-2">الملكية</p>
            ...
            <Card>
              <CardContent className="p-3">
                <p className="text-xs font-semibold text-gray-700 mb-2">الوقت</p>
                <div className="grid grid-cols-2 gap-2 mb-3">
                  <div>
                    <label className="text-[10px] text-gray-500 block mb-1">من ساعة</label>
                    <Input
                      type="number"
                      min={0}
                      max={23}
                  ...
                  <div>
                    <label className="text-[10px] text-gray-500 block mb-1">إلى ساعة</label>
                    <Input
                      type="number"
                      min={1}
                      max={24}
                ...
                <p className="text-xs text-gray-600 mb-1">أيام الأسبوع المسموحة</p>
                    ...
                    return (
                      <button
                        ...
                        className={`px-2 py-1 rounded text-xs border ${
                          active ? "bg-blue-50 border-blue-300 text-blue-700" : "bg-gray-100 border-gray-200 text-gray-400 line-through"
                        }`}
                      >
                        {label}
                      </button>
                ...
                <p className="text-[10px] text-gray-500 mt-1">انقر على اليوم لتفعيله/تعطيله. الافتراضي كل الأيام مسموحة.</p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-3">
                <p className="text-xs font-semibold text-gray-700 mb-2">شبكة وطوارئ</p>
                <ListInput
            ...
            <Card className="bg-blue-50 border-blue-200">
              <CardContent className="p-3">
                <p className="text-[10px] font-semibold text-blue-700 mb-1">معاينة JSON:</p>
    ...
    <div className="mb-2">
      ...
      {value.length > 0 && (
        <div className="flex flex-wrap gap-1 mt-1">
          {value.map((v) => (
            <Badge key={v} variant="outline" className="text-xs bg-blue-50 cursor-pointer"
