      ...
      <FormGrid cols={2}>
        ...
        {linkedEntityType && (
          <div className="space-y-1.5">
            <label className="text-sm font-medium">اختر الكيان</label>
            <Controller
              name="linkedEntityId"
              control={control}
              render={({ field }) => (
...
function ClientSelectBlock({ clients }: { clients: any[] }) {
    ...
    <CreatePageLayout title="مهمة جديدة" backPath="/tasks">
      ...
      >
        <FormGrid cols={2}>
          ...
          <ClientSelectBlock clients={clients} />
          <FormTextareaField name="description" label="الوصف" rows={3} className="md:col-span-2" />
        </FormGrid>
        <EntityLinkBlock />
      </FormShell>
    </CreatePageLayout>
