    ...
    <CreatePageLayout title="إضافة مؤشر أداء" backPath="/bi/kpis">
      ...
      >
        <FormGrid cols={2}>
          ...
          <FormSelectField name="module" label="القسم" placeholder="اختر القسم" options={MODULE_OPTIONS} />
        ...
        <FormTextField name="formula" label="المعادلة" placeholder="مثال: (الإيرادات / الهدف) × 100" />
