    ...
    <CreatePageLayout title="تسجيل خطر جديد" backPath="/governance/risks">
      ...
      >
        <FormGrid cols={2}>
          ...
          <FormSelectField name="severity" label="الخطورة" options={LEVEL_OPTIONS} />
          <FormSelectField name="likelihood" label="مستوى الاحتمالية" options={LEVEL_OPTIONS} />
          <FormSelectField name="impact" label="مستوى التأثير" options={LEVEL_OPTIONS} />
          <FormSelectField name="status" label="الحالة" options={STATUS_OPTIONS} />
          <FormSelectField name="assignedTo" label="المسؤول عن المعالجة" options={employeeOptions} placeholder="— اختياري —" />
        </FormGrid>
