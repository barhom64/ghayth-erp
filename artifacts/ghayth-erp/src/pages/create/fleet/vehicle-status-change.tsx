...
// Status-change wizard — single click + impact preview + confirm. No
// FormShell shape needed (no input fields, no zod schema). The
// previous version imported the manual-form hooks as dead code.
