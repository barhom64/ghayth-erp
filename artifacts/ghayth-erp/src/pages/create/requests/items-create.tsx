    ...
    <CreatePageLayout title="طلب جديد" backPath="/requests">
      ...
      >
        <FormGrid cols={2}>
          ...
          <FormSelectField name="typeId" label="النوع" options={typeOptions} placeholder="اختر النوع" />
        ...
        <FormTextareaField name="description" label="التفاصيل" placeholder="تفاصيل الطلب..." />
      </FormShell>
    </CreatePageLayout>
  );
}
