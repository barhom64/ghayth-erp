    ...
    <CreatePageLayout title="حملة تسويقية جديدة" backPath="/marketing">
      ...
      >
        <FormGrid cols={2}>
          ...
          <FormSelectField name="channel" label="القناة" options={CHANNEL_OPTIONS} placeholder="اختر القناة" />
          ...
          <FormTextareaField name="description" label="الوصف" placeholder="وصف الحملة التسويقية..." className="md:col-span-2" />
        </FormGrid>
