...
export default function CrmCreate() {
  ...
  const addOpp = useApiMutation("/crm/opportunities", "POST", [
    ["crm-opportunities"],
    ["crm-stats"],
    ["crm-pipeline"],
  ]);
    ...
    <CreatePageLayout title="فرصة تجارية جديدة" backPath="/crm">
      ...
      >
        <FormGrid cols={2}>
          ...
          <FormSelectField name="clientId" label="العميل" placeholder="بدون عميل" options={clientOptions} />
          <FormSelectField name="stage" label="المرحلة" options={STAGE_OPTIONS} />
          <FormSelectField name="assignedTo" label="المسند إليه" placeholder="اختر الموظف" options={employeeOptions} />
          ...
          <FormSelectField name="source" label="المصدر" placeholder="اختر المصدر" options={SOURCE_OPTIONS} />
