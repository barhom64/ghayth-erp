...
const schema = z.object({
  ...
  floors: z
    .string()
    .optional()
    .refine((v) => !v || Number(v) >= 0, "عدد الطوابق يجب أن يكون صفر أو أكثر"),
...
export default function BuildingsCreate() {
  ...
  return (
    ...
    >
      <CreationDateField />
      <h3 className="flex items-center gap-2 text-lg font-semibold mt-4 mb-3">
        <Building2 className="h-5 w-5 text-status-info-foreground" /> بيانات المبنى
      </h3>
      <FormShell
        schema={schema}
        defaultValues={{
          ...
          try {
            await apiFetch("/properties/buildings", {
              ...
              body: JSON.stringify({
                ...
                nationalAddress:
                  values.district || values.street || values.buildingNumber || values.postalCode
                    ? {
            ...
            toast({
              variant: "destructive",
              title: "حدث خطأ أثناء إضافة المبنى",
      ...
      >
        ...
        <div className="border-t pt-4 mt-4">
          ...
          <FormGrid cols={2}>
            ...
            <FormSelectField name="ownerId" label="المالك" placeholder="— بدون مالك —" options={ownerOptions} />
