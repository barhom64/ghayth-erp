...
function ConditionalSections() {
  ...
  const isCompany = watch("tenantType") === "company";
  return (
    <>
      {isCompany && (
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-base flex items-center gap-2">
              <Building2 className="h-4 w-4 text-status-info-foreground" /> بيانات الشركة
            </CardTitle>
          </CardHeader>
          <CardContent>
            <FormGrid cols={2}>
      ...
      {!isCompany && (
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-base flex items-center gap-2">
              <Briefcase className="h-4 w-4 text-status-warning-foreground" /> البيانات الشخصية
            </CardTitle>
          </CardHeader>
          <CardContent>
            <FormGrid cols={3}>
              <FormDateField name="birthDate" label="تاريخ الميلاد" />
              <FormSelectField name="gender" label="الجنس" placeholder="— غير محدد —" options={GENDER} />
              <FormSelectField name="maritalStatus" label="الحالة الاجتماعية" placeholder="— غير محدد —" options={MARITAL} />
    ...
    <CreatePageLayout title="إضافة مستأجر جديد" backPath="/properties/tenants">
      ...
      >
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-base flex items-center gap-2">
              <User className="h-4 w-4 text-status-info-foreground" /> البيانات الأساسية
            </CardTitle>
          </CardHeader>
          <CardContent>
            <FormGrid cols={3}>
              <FormSelectField name="tenantType" label="نوع المستأجر" options={TENANT_TYPE} />
              <NameLabel />
              ...
              <FormSelectField name="idType" label="نوع الهوية" options={ID_TYPE} />
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-base flex items-center gap-2">
              <Shield className="h-4 w-4 text-status-error-foreground" /> الكفيل / الضامن
            </CardTitle>
          </CardHeader>
          <CardContent>
            <FormGrid cols={2}>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-base flex items-center gap-2">
              <Phone className="h-4 w-4 text-status-success-foreground" /> الطوارئ والسكن السابق
            </CardTitle>
          </CardHeader>
          <CardContent>
            <FormGrid cols={2}>
