...
const CATEGORIES: WorkflowCategory[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { title: "DSO Trend", description: "Days Sales Outstanding تاريخي", href: "/finance/reports/dso-trend", icon: TrendingUp },
      ...
      { title: "تسجيل دفعة عميل (FIFO)", description: "Receipt wizard مع تطبيق تلقائي", href: "/finance/receivables/receipt", icon: FileSignature },
    ],
  },
  {
    title: "ذمم دائنة (AP)",
  ...
  },
  {
    ...
    entries: [
      ...
      { title: "تحويل بين الحسابات", description: "بطاقات مرئية source/target", href: "/finance/account-transfer", icon: Banknote },
      { title: "مصروف متعدد البنود", description: "مع ضرائب وعدم ضرائب مختلطة", href: "/finance/multi-line-expense", icon: Receipt },
      { title: "Cost Splitter", description: "قسّم فاتورة على عدة جهات", href: "/finance/cost-splitter", icon: Layers },
    ],
  },
  {
  ...
  },
  {
    ...
    entries: [
      ...
      { title: "ملخص WHT", description: "ضريبة الاستقطاع", href: "/finance/wht-summary", icon: Receipt },
      { title: "تسوية VAT", description: "VAT Reconciliation", href: "/finance/vat-reconciliation", icon: ScaleIcon },
  ...
  },
  {
    ...
    entries: [
      ...
      { title: "Unmapped Lines", description: "بنود بدون ربط", href: "/finance/unmapped-lines", icon: AlertTriangle },
      { title: "Posting Activity", description: "نشاط الترحيل", href: "/finance/posting-activity", icon: Activity },
    ],
  },
];
