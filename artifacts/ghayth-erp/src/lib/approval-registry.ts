...
export const APPROVAL_TYPES: ApprovalTypeDef[] = [
  { key: "leave",          label: "إجازة",       pendingKey: "pendingLeaves",          approveEndpoint: "/hr/leave-requests/:id/approve",          badgeClass: "bg-blue-100 text-status-info-foreground" },
  { key: "advance",        label: "سلفة",        pendingKey: "pendingAdvances",         approveEndpoint: "/finance/salary-advances/:id/approve",    badgeClass: "bg-green-100 text-status-success-foreground" },
  ...
  { key: "purchase",       label: "طلب شراء",    pendingKey: "pendingPurchases",        approveEndpoint: "/finance/purchase-requests/:id/approve",  badgeClass: "bg-amber-100 text-status-warning-foreground" },
  ...
  { key: "exit",           label: "مغادرة",      pendingKey: "pendingExitRequests",     approveEndpoint: "/hr/exit/:id/approve",                    badgeClass: "bg-red-100 text-status-error-foreground" },
  ...
  { key: "violation",      label: "مخالفة",      pendingKey: "pendingViolations",       approveEndpoint: "/hr/violations/:id/approve",              badgeClass: "bg-red-100 text-status-error-foreground" },
