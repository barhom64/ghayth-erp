...
export const NAV_MODULES: NavModule[] = [
  ...
  { key: "calendar", label: "التقويم", icon: "calendar-outline", route: "/calendar", selfService: true, built: true },
  { key: "approvals", label: "مركز الاعتماد", icon: "checkmark-done-outline", route: "/action-center", selfService: true, built: true },
