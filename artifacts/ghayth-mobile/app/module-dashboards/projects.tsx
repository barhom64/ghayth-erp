...
export default function ProjectsModuleDashboard() {
  const c = useColors();
  const { data, isLoading, isError, refetch } = useList<ModuleDashboard>('/api/module-dashboards/projects');
  ...
  return (
    <View style={{ flex: 1, backgroundColor: c.bg }}>
      ...
      <ScrollView contentContainerStyle={{ padding: 16 }}>
        <Text style={{ color: c.text, fontSize: 16, fontWeight: '600', marginBottom: 12 }}>ملخص وحدة المشاريع</Text>
        {d?.value !== undefined && (
