...
interface Milestone { id?: number; name?: string; dueDate?: string; status?: string; }

export default function ProjectMilestonesScreen() {
  const c = useColors();
  const { data, isLoading, isError, refetch } = useList<Milestone[]>('/api/projects/0/milestones');
  ...
  return (
    <View style={{ flex: 1, backgroundColor: c.bg }}>
      <Stack.Screen options={{ title: 'معالم المشروع' }} />
