...
export default function EmployeeUmrahAssignmentsScreen() {
  const c = useColors();
  const { data, isLoading, isError, refetch } = useList<ItemType[]>('/api/umrah/employees/0/assignments');
  ...
  return (
    <View style={{ flex: 1, backgroundColor: c.bg }}>
      <Stack.Screen options={{ title: 'تعيينات موظف العمرة' }} />
