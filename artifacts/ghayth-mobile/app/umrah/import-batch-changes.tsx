...
export default function ImportBatchChangesScreen() {
  const c = useColors();
  const { data, isLoading, isError, refetch } = useList<ItemType[]>('/api/umrah/import/batches/0/changes');
  ...
  return (
    <View style={{ flex: 1, backgroundColor: c.bg }}>
      <Stack.Screen options={{ title: 'تغييرات دفعة الاستيراد' }} />
