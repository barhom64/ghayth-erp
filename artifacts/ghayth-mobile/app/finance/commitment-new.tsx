...
const TYPE_OPTIONS = [
  { label: 'دوري', value: 'recurring' },
  { label: 'لمرة واحدة', value: 'one_time' },
];

export default function التزامماليجديدScreen() {
  const c = useColors();
  ...
  const mutation = useMutation('/api/finance/commitments', 'POST');
  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: c.bg }} contentContainerStyle={{ padding: 16, gap: 16, paddingBottom: 40 }}>
      <Stack.Screen options={{ title: 'التزام مالي جديد' }} />
