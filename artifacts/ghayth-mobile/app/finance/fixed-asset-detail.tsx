  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: c.bg }} contentContainerStyle={{ paddingBottom: 40 }}>
      ...
      <View style={{ padding: 16, gap: 12 }}>
        ...
        <GButton title="صرف أصل ثابت" icon="cube-outline" variant="secondary" onPress={() => router.push({ pathname: '/finance/fixed-asset-disposal-new' as never, params: { assetId: id } })} />
      </View>
    </ScrollView>
  );
}
