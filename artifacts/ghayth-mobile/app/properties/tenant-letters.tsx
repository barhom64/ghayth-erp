...
interface Letter { id?: number; subject?: string; date?: string; type?: string; }

export default function TenantLettersScreen() {
  const c = useColors();
  const { data, isLoading, isError, refetch } = useList<Letter[]>('/api/properties/tenants/0/letters');
  ...
  return (
    <View style={{ flex: 1, backgroundColor: c.bg }}>
      <Stack.Screen options={{ title: 'خطابات المستأجر' }} />
