# /finance/opening-balances/create — `artifacts/ghayth-erp/src/pages/finance/cashflow-dashboard.tsx`
...
- ملاحظة: `landed=/dashboard expected=/finance/opening-balances/create; write POST /api/intelligence/activity → 200`
- لقطة: `audit/screenshots/finance_opening_balances_create.png`
