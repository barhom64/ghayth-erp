# /umrah/penalties/:id — `artifacts/ghayth-erp/src/pages/details/umrah-penalty-detail.tsx`
...
## 6. النتيجة (Verdict)
- Runtime audit: **TBD** — راجع `audit/runtime-audit-results.json` (`/umrah/penalties/:id`)
- توصية: **TBD**
