...
|--------|--------|--------|------|-----------|--------|--------|
| [/fleet](./fleet.md) | `/fleet` | `fleet` | 520 | 0 | 1 | 0 |
| [/fleet/vehicles/create](./fleet-vehicles-create.md) | `/fleet/vehicles/create` | `create` | 159 | 1 | 3 | 0 |
| [/fleet/drivers](./fleet-drivers.md) | `/fleet/drivers` | `drivers` | 154 | 1 | 1 | 0 |
...
| [/fleet/fuel](./fleet-fuel.md) | `/fleet/fuel` | `fuel` | 66 | 0 | 0 | 0 |
...
| [/fleet/insurance](./fleet-insurance.md) | `/fleet/insurance` | `insurance` | 90 | 1 | 0 | 0 |
| [/fleet/insurance/create](./fleet-insurance-create.md) | `/fleet/insurance/create` | `create` | 118 | 1 | 3 | 0 |
