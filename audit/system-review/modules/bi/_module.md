...
|--------|--------|--------|------|-----------|--------|--------|
| [/bi](./bi.md) | `/bi` | `bi` | 48 | 0 | 0 | 0 |
| [/bi/dashboards](./bi-dashboards.md) | `/bi/dashboards` | `dashboards` | 48 | 0 | 0 | 0 |
| [/bi/dashboards/create](./bi-dashboards-create.md) | `/bi/dashboards/create` | `create` | 70 | 0 | 3 | 0 |
| [/bi/kpis](./bi-kpis.md) | `/bi/kpis` | `kpis` | 48 | 0 | 0 | 0 |
