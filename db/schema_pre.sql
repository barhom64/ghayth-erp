...
ALTER TABLE IF EXISTS ONLY public.zatca_settings DROP CONSTRAINT IF EXISTS "zatca_settings_branchId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.wps_skip_alerts DROP CONSTRAINT IF EXISTS "wps_skip_alerts_companyId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.warehouse_movements DROP CONSTRAINT IF EXISTS "warehouse_movements_lotId_fkey";
ALTER TABLE IF EXISTS ONLY public.warehouse_cycle_counts DROP CONSTRAINT IF EXISTS "warehouse_cycle_counts_planId_fkey";
ALTER TABLE IF EXISTS ONLY public.warehouse_cycle_counts DROP CONSTRAINT IF EXISTS "warehouse_cycle_counts_companyId_fkey";
ALTER TABLE IF EXISTS ONLY public.warehouse_cycle_count_plans DROP CONSTRAINT IF EXISTS "warehouse_cycle_count_plans_warehouseId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.umrah_penalties DROP CONSTRAINT IF EXISTS "umrah_penalties_createdBy_fkey";
ALTER TABLE IF EXISTS ONLY public.umrah_penalties DROP CONSTRAINT IF EXISTS "umrah_penalties_branchId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.umrah_packages DROP CONSTRAINT IF EXISTS "umrah_packages_updatedBy_fkey";
ALTER TABLE IF EXISTS ONLY public.umrah_packages DROP CONSTRAINT IF EXISTS "umrah_packages_seasonId_fkey";
ALTER TABLE IF EXISTS ONLY public.umrah_packages DROP CONSTRAINT IF EXISTS "umrah_packages_createdBy_fkey";
ALTER TABLE IF EXISTS ONLY public.umrah_packages DROP CONSTRAINT IF EXISTS "umrah_packages_branchId_fkey";
ALTER TABLE IF EXISTS ONLY public.umrah_import_logs DROP CONSTRAINT IF EXISTS "umrah_import_logs_updatedBy_fkey";
ALTER TABLE IF EXISTS ONLY public.umrah_import_logs DROP CONSTRAINT IF EXISTS "umrah_import_logs_seasonId_fkey";
ALTER TABLE IF EXISTS ONLY public.umrah_import_logs DROP CONSTRAINT IF EXISTS "umrah_import_logs_createdBy_fkey";
ALTER TABLE IF EXISTS ONLY public.umrah_import_logs DROP CONSTRAINT IF EXISTS "umrah_import_logs_branchId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.umrah_agent_invoices DROP CONSTRAINT IF EXISTS "umrah_agent_invoices_branchId_fkey";
ALTER TABLE IF EXISTS ONLY public.umrah_agent_invoices DROP CONSTRAINT IF EXISTS "umrah_agent_invoices_agentId_fkey";
ALTER TABLE IF EXISTS ONLY public.transport_itinerary_legs DROP CONSTRAINT IF EXISTS "transport_itinerary_legs_itineraryId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.thread_snoozes DROP CONSTRAINT IF EXISTS "thread_snoozes_userId_fkey";
ALTER TABLE IF EXISTS ONLY public.thread_snoozes DROP CONSTRAINT IF EXISTS "thread_snoozes_companyId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.teams DROP CONSTRAINT IF EXISTS "teams_leaderAssignmentId_fkey";
ALTER TABLE IF EXISTS ONLY public.teams DROP CONSTRAINT IF EXISTS "teams_departmentId_fkey";
ALTER TABLE IF EXISTS ONLY public.teams DROP CONSTRAINT IF EXISTS "teams_companyId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.supervision_lines DROP CONSTRAINT IF EXISTS "supervision_lines_supervisorAssignmentId_fkey";
ALTER TABLE IF EXISTS ONLY public.supervision_lines DROP CONSTRAINT IF EXISTS "supervision_lines_superviseeAssignmentId_fkey";
ALTER TABLE IF EXISTS ONLY public.supervision_lines DROP CONSTRAINT IF EXISTS "supervision_lines_companyId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.scoring_weights_per_company DROP CONSTRAINT IF EXISTS "scoring_weights_per_company_companyId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.purchase_order_items DROP CONSTRAINT IF EXISTS "purchase_order_items_accountId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.positions DROP CONSTRAINT IF EXISTS "positions_companyId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.pbx_call_transcripts DROP CONSTRAINT IF EXISTS "pbx_call_transcripts_callId_fkey";
ALTER TABLE IF EXISTS ONLY public.pbx_call_recordings DROP CONSTRAINT IF EXISTS "pbx_call_recordings_callId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.message_read_state DROP CONSTRAINT IF EXISTS "message_read_state_userId_fkey";
ALTER TABLE IF EXISTS ONLY public.message_read_state DROP CONSTRAINT IF EXISTS "message_read_state_messageLogId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.legal_entities DROP CONSTRAINT IF EXISTS "legal_entities_companyId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.journal_lines DROP CONSTRAINT IF EXISTS "journal_lines_costCenterId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.ivr_menu_options DROP CONSTRAINT IF EXISTS "ivr_menu_options_targetMenuId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.goods_receipt_items DROP CONSTRAINT IF EXISTS "goods_receipt_items_accountId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.fx_realized_postings DROP CONSTRAINT IF EXISTS "fx_realized_postings_journalEntryId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.field_tracking_points DROP CONSTRAINT IF EXISTS "field_tracking_points_companyId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.employee_team_memberships DROP CONSTRAINT IF EXISTS "employee_team_memberships_teamId_fkey";
ALTER TABLE IF EXISTS ONLY public.employee_team_memberships DROP CONSTRAINT IF EXISTS "employee_team_memberships_assignmentId_fkey";
ALTER TABLE IF EXISTS ONLY public.employee_signals DROP CONSTRAINT IF EXISTS "employee_signals_companyId_fkey";
ALTER TABLE IF EXISTS ONLY public.employee_scores DROP CONSTRAINT IF EXISTS "employee_scores_companyId_fkey";
ALTER TABLE IF EXISTS ONLY public.employee_project_assignments DROP CONSTRAINT IF EXISTS "employee_project_assignments_projectId_fkey";
ALTER TABLE IF EXISTS ONLY public.employee_project_assignments DROP CONSTRAINT IF EXISTS "employee_project_assignments_costCenterId_fkey";
ALTER TABLE IF EXISTS ONLY public.employee_project_assignments DROP CONSTRAINT IF EXISTS "employee_project_assignments_assignmentId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.employee_lifecycle_events DROP CONSTRAINT IF EXISTS "employee_lifecycle_events_employeeId_fkey";
ALTER TABLE IF EXISTS ONLY public.employee_lifecycle_events DROP CONSTRAINT IF EXISTS "employee_lifecycle_events_companyId_fkey";
ALTER TABLE IF EXISTS ONLY public.employee_lifecycle_events DROP CONSTRAINT IF EXISTS "employee_lifecycle_events_branchId_fkey";
ALTER TABLE IF EXISTS ONLY public.employee_lifecycle_events DROP CONSTRAINT IF EXISTS "employee_lifecycle_events_assignmentId_fkey";
ALTER TABLE IF EXISTS ONLY public.employee_lifecycle_events DROP CONSTRAINT IF EXISTS "employee_lifecycle_events_actorUserId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.employee_committee_memberships DROP CONSTRAINT IF EXISTS "employee_committee_memberships_committeeId_fkey";
ALTER TABLE IF EXISTS ONLY public.employee_committee_memberships DROP CONSTRAINT IF EXISTS "employee_committee_memberships_assignmentId_fkey";
ALTER TABLE IF EXISTS ONLY public.employee_categories DROP CONSTRAINT IF EXISTS "employee_categories_companyId_fkey";
ALTER TABLE IF EXISTS ONLY public.employee_assignments DROP CONSTRAINT IF EXISTS "employee_assignments_positionId_fkey";
ALTER TABLE IF EXISTS ONLY public.employee_assignments DROP CONSTRAINT IF EXISTS "employee_assignments_managerId_fkey";
ALTER TABLE IF EXISTS ONLY public.employee_assignments DROP CONSTRAINT IF EXISTS "employee_assignments_legalEntityId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.employee_assets DROP CONSTRAINT IF EXISTS "employee_assets_companyId_fkey";
ALTER TABLE IF EXISTS ONLY public.employee_assets DROP CONSTRAINT IF EXISTS "employee_assets_assignmentId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.departments DROP CONSTRAINT IF EXISTS "departments_administrationId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.committees DROP CONSTRAINT IF EXISTS "committees_companyId_fkey";
ALTER TABLE IF EXISTS ONLY public.committees DROP CONSTRAINT IF EXISTS "committees_chairAssignmentId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.branches DROP CONSTRAINT IF EXISTS "branches_legalEntityId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.attendance_policies_per_category DROP CONSTRAINT IF EXISTS "attendance_policies_per_category_companyId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.approval_authorities DROP CONSTRAINT IF EXISTS "approval_authorities_companyId_fkey";
ALTER TABLE IF EXISTS ONLY public.approval_authorities DROP CONSTRAINT IF EXISTS "approval_authorities_assignmentId_fkey";
...
ALTER TABLE IF EXISTS ONLY public.ai_prompt_reviews DROP CONSTRAINT IF EXISTS "ai_prompt_reviews_promptId_fkey";
ALTER TABLE IF EXISTS ONLY public.ai_prompt_evaluations DROP CONSTRAINT IF EXISTS "ai_prompt_evaluations_promptId_fkey";
ALTER TABLE IF EXISTS ONLY public.ai_prompt_evaluation_results DROP CONSTRAINT IF EXISTS "ai_prompt_evaluation_results_testCaseId_fkey";
ALTER TABLE IF EXISTS ONLY public.ai_prompt_evaluation_results DROP CONSTRAINT IF EXISTS "ai_prompt_evaluation_results_evaluationId_fkey";
ALTER TABLE IF EXISTS ONLY public.administrations DROP CONSTRAINT IF EXISTS "administrations_companyId_fkey";
ALTER TABLE IF EXISTS ONLY public.administrations DROP CONSTRAINT IF EXISTS "administrations_branchId_fkey";
...
DROP TRIGGER IF EXISTS trg_journal_entries_status_axes ON public.journal_entries;
...
DROP INDEX IF EXISTS public.zatca_b2c_pause_events_company_created_idx;
DROP INDEX IF EXISTS public.warehouse_stock_lots_writeoff_journal_idx;
...
DROP INDEX IF EXISTS public.uq_subsidiary_provisioning_failure_open;
...
DROP INDEX IF EXISTS public.uq_field_tracking_assignment_captured;
...
DROP INDEX IF EXISTS public.uniq_thread_snoozes_active;
...
DROP INDEX IF EXISTS public.ual_user_idx;
DROP INDEX IF EXISTS public.ual_page_idx;
DROP INDEX IF EXISTS public.ual_created_idx;
DROP INDEX IF EXISTS public.ual_company_idx;
...
DROP INDEX IF EXISTS public.srec_user_idx;
DROP INDEX IF EXISTS public.srec_company_idx;
...
DROP INDEX IF EXISTS public.rfm_segment_idx;
DROP INDEX IF EXISTS public.rfm_company_idx;
...
DROP INDEX IF EXISTS public.project_phases_company_idx;
...
DROP INDEX IF EXISTS public.pra_client_idx;
DROP INDEX IF EXISTS public.pra_applied_idx;
DROP INDEX IF EXISTS public.pr_validity_idx;
DROP INDEX IF EXISTS public.pr_status_idx;
...
DROP INDEX IF EXISTS public.pc_rule_idx;
...
DROP INDEX IF EXISTS public.idx_zatca_submission_log_pending;
DROP INDEX IF EXISTS public.idx_zatca_settings_companyid;
DROP INDEX IF EXISTS public.idx_zatca_settings_branchid;
...
DROP INDEX IF EXISTS public.idx_wps_skip_alerts_company_period;
DROP INDEX IF EXISTS public.idx_wps_runs_status_period;
DROP INDEX IF EXISTS public.idx_wps_runs_delivery_pending;
...
DROP INDEX IF EXISTS public.idx_wht_categories_active;
...
DROP INDEX IF EXISTS public.idx_warehouses_company;
DROP INDEX IF EXISTS public.idx_warehouses_branch;
DROP INDEX IF EXISTS public.idx_warehouses_active;
DROP INDEX IF EXISTS public.idx_warehouse_stock_serials_warehouse;
DROP INDEX IF EXISTS public.idx_warehouse_stock_serials_status;
DROP INDEX IF EXISTS public.idx_warehouse_stock_serials_product;
DROP INDEX IF EXISTS public.idx_warehouse_stock_serials_lot;
DROP INDEX IF EXISTS public.idx_warehouse_products_item_type;
DROP INDEX IF EXISTS public.idx_warehouse_movements_serial;
DROP INDEX IF EXISTS public.idx_warehouse_movements_lot;
DROP INDEX IF EXISTS public.idx_warehouse_movements_je;
DROP INDEX IF EXISTS public.idx_warehouse_cycle_counts_plan;
...
DROP INDEX IF EXISTS public.idx_umrah_seasons_branch_alive;
...
DROP INDEX IF EXISTS public.idx_umrah_penalties_branch_alive;
...
DROP INDEX IF EXISTS public.idx_umrah_import_logs_branch_alive;
...
DROP INDEX IF EXISTS public.idx_umrah_import_batches_deletedat;
...
DROP INDEX IF EXISTS public.idx_umrah_agent_invoices_branch_alive;
...
DROP INDEX IF EXISTS public.idx_transport_legs_order;
DROP INDEX IF EXISTS public.idx_transport_legs_lookup;
DROP INDEX IF EXISTS public.idx_transport_itineraries_lookup;
DROP INDEX IF EXISTS public.idx_transport_bookings_to_kind;
DROP INDEX IF EXISTS public.idx_transport_bookings_route_pattern;
DROP INDEX IF EXISTS public.idx_transport_bookings_from_kind;
DROP INDEX IF EXISTS public.idx_transport_bookings_family;
...
DROP INDEX IF EXISTS public.idx_thread_snoozes_wake;
...
DROP INDEX IF EXISTS public.idx_teams_company_active;
...
DROP INDEX IF EXISTS public.idx_supervision_lines_supervisor;
DROP INDEX IF EXISTS public.idx_supervision_lines_supervisee;
DROP INDEX IF EXISTS public.idx_subsidiary_provisioning_failure_company_open;
...
DROP INDEX IF EXISTS public.idx_spa_journal;
...
DROP INDEX IF EXISTS public.idx_scoring_weights_company;
...
DROP INDEX IF EXISTS public.idx_route_patterns_active;
DROP INDEX IF EXISTS public.idx_route_estimates_lookup;
DROP INDEX IF EXISTS public.idx_route_estimates_expiry;
...
DROP INDEX IF EXISTS public.idx_payroll_runs_deleted;
...
DROP INDEX IF EXISTS public.idx_official_letters_source;
...
DROP INDEX IF EXISTS public.idx_notifications_ack;
...
DROP INDEX IF EXISTS public.idx_message_read_state_user;
...
DROP INDEX IF EXISTS public.idx_maintenance_requests_linked_expense;
...
DROP INDEX IF EXISTS public.idx_legal_sessions_deletedat;
DROP INDEX IF EXISTS public.idx_legal_judgments_companyid;
DROP INDEX IF EXISTS public.idx_legal_entities_company;
...
DROP INDEX IF EXISTS public.idx_journal_lines_dim_vehicle;
...
DROP INDEX IF EXISTS public.idx_journal_entries_original_currency;
DROP INDEX IF EXISTS public.idx_journal_entries_deleted;
...
DROP INDEX IF EXISTS public.idx_job_applications_employee;
DROP INDEX IF EXISTS public.idx_job_applications_deletedat;
DROP INDEX IF EXISTS public.idx_ivr_menus_company_status;
DROP INDEX IF EXISTS public.idx_ivr_menu_options_menu;
DROP INDEX IF EXISTS public.idx_invoices_zatca_b2c_reportable;
...
DROP INDEX IF EXISTS public.idx_gov_integration_links_deletedat;
...
DROP INDEX IF EXISTS public.idx_fleet_vehicles_valid_passengers;
DROP INDEX IF EXISTS public.idx_fleet_vehicles_valid_cargo;
DROP INDEX IF EXISTS public.idx_fleet_vehicles_type;
DROP INDEX IF EXISTS public.idx_fleet_vehicles_service_types;
...
DROP INDEX IF EXISTS public.idx_fleet_rental_contracts_driver;
...
DROP INDEX IF EXISTS public.idx_fleet_drivers_national_id;
DROP INDEX IF EXISTS public.idx_fleet_drivers_license_class;
DROP INDEX IF EXISTS public.idx_fleet_drivers_iqama;
...
DROP INDEX IF EXISTS public.idx_field_tracking_points_company_day;
DROP INDEX IF EXISTS public.idx_field_tracking_points_assignment_ts;
...
DROP INDEX IF EXISTS public.idx_employee_signals_company_period;
DROP INDEX IF EXISTS public.idx_employee_signals_assignment;
DROP INDEX IF EXISTS public.idx_employee_scores_company_period;
DROP INDEX IF EXISTS public.idx_employee_scores_assignment_period;
...
DROP INDEX IF EXISTS public.idx_employee_categories_company;
DROP INDEX IF EXISTS public.idx_employee_assignments_status;
DROP INDEX IF EXISTS public.idx_employee_assignments_positionid;
...
DROP INDEX IF EXISTS public.idx_employee_assignments_categorykey;
DROP INDEX IF EXISTS public.idx_employee_assignments_branch;
DROP INDEX IF EXISTS public.idx_employee_assignments_access_grant;
DROP INDEX IF EXISTS public.idx_employee_assets_assignment;
DROP INDEX IF EXISTS public.idx_employee_assets_active;
DROP INDEX IF EXISTS public.idx_emp_salary_comp_employee;
DROP INDEX IF EXISTS public.idx_emp_salary_comp_company;
DROP INDEX IF EXISTS public.idx_emp_project_assignments_active;
DROP INDEX IF EXISTS public.idx_emp_lifecycle_employee;
DROP INDEX IF EXISTS public.idx_emp_lifecycle_company_state;
...
DROP INDEX IF EXISTS public.idx_driver_nav_driver;
DROP INDEX IF EXISTS public.idx_driver_nav_active_per_order;
...
DROP INDEX IF EXISTS public.idx_documents_linked_entity;
...
DROP INDEX IF EXISTS public.idx_departments_administration;
...
DROP INDEX IF EXISTS public.idx_committees_company_active;
...
DROP INDEX IF EXISTS public.idx_cargo_checkpoints_type_recorded;
DROP INDEX IF EXISTS public.idx_cargo_checkpoints_manifest;
...
DROP INDEX IF EXISTS public.idx_budget_approval_requests_deletedat;
DROP INDEX IF EXISTS public.idx_budget_approval_requests_deleted_at;
DROP INDEX IF EXISTS public.idx_budget_approval_requests_companyid;
...
DROP INDEX IF EXISTS public.idx_audit_logs_impersonation;
...
DROP INDEX IF EXISTS public.idx_audit_logs_active_dept;
DROP INDEX IF EXISTS public.idx_audit_archive_company;
DROP INDEX IF EXISTS public.idx_attendance_policies_per_category_company;
...
DROP INDEX IF EXISTS public.idx_approval_authorities_assignment;
...
DROP INDEX IF EXISTS public.idx_ai_request_logs_model_created;
DROP INDEX IF EXISTS public.idx_ai_request_logs_feature_created;
DROP INDEX IF EXISTS public.idx_ai_request_logs_company_created;
DROP INDEX IF EXISTS public.idx_ai_providers_status_priority;
DROP INDEX IF EXISTS public.idx_ai_providers_capabilities;
DROP INDEX IF EXISTS public.idx_ai_prompts_slug_status;
DROP INDEX IF EXISTS public.idx_ai_prompt_test_cases_slug;
DROP INDEX IF EXISTS public.idx_ai_prompt_reviews_prompt;
DROP INDEX IF EXISTS public.idx_ai_prompt_evaluations_slug_version;
DROP INDEX IF EXISTS public.idx_ai_prompt_evaluations_prompt;
DROP INDEX IF EXISTS public.idx_ai_prompt_evaluation_results_eval;
DROP INDEX IF EXISTS public.idx_ai_prompt_evaluation_results_case;
DROP INDEX IF EXISTS public.idx_administrations_company_active;
DROP INDEX IF EXISTS public.idx_administrations_branch;
...
DROP INDEX IF EXISTS public.development_units_project_idx;
...
ALTER TABLE IF EXISTS ONLY public.zatca_b2c_pause_events DROP CONSTRAINT IF EXISTS zatca_b2c_pause_events_pkey;
ALTER TABLE IF EXISTS ONLY public.wps_skip_alerts DROP CONSTRAINT IF EXISTS wps_skip_alerts_pkey;
...
ALTER TABLE IF EXISTS ONLY public.warehouse_cycle_count_plans DROP CONSTRAINT IF EXISTS warehouse_cycle_count_plans_pkey;
ALTER TABLE IF EXISTS ONLY public.warehouse_cycle_count_plans DROP CONSTRAINT IF EXISTS "warehouse_cycle_count_plans_companyId_warehouseId_period_pl_key";
...
ALTER TABLE IF EXISTS ONLY public.transport_route_patterns DROP CONSTRAINT IF EXISTS uq_route_pattern_code;
...
ALTER TABLE IF EXISTS ONLY public.umrah_transport_pilgrims DROP CONSTRAINT IF EXISTS umrah_transport_pilgrims_pkey;
...
ALTER TABLE IF EXISTS ONLY public.transport_route_patterns DROP CONSTRAINT IF EXISTS transport_route_patterns_pkey;
ALTER TABLE IF EXISTS ONLY public.transport_route_estimates DROP CONSTRAINT IF EXISTS transport_route_estimates_pkey;
ALTER TABLE IF EXISTS ONLY public.transport_price_rules DROP CONSTRAINT IF EXISTS transport_price_rules_pkey;
ALTER TABLE IF EXISTS ONLY public.transport_planning_settings DROP CONSTRAINT IF EXISTS transport_planning_settings_pkey;
ALTER TABLE IF EXISTS ONLY public.transport_locations DROP CONSTRAINT IF EXISTS transport_locations_pkey;
ALTER TABLE IF EXISTS ONLY public.transport_itinerary_legs DROP CONSTRAINT IF EXISTS transport_itinerary_legs_pkey;
ALTER TABLE IF EXISTS ONLY public.transport_itineraries DROP CONSTRAINT IF EXISTS transport_itineraries_pkey;
...
ALTER TABLE IF EXISTS ONLY public.thread_snoozes DROP CONSTRAINT IF EXISTS thread_snoozes_pkey;
...
ALTER TABLE IF EXISTS ONLY public.supplier_payment_allocations DROP CONSTRAINT IF EXISTS supplier_payment_allocations_pkey;
ALTER TABLE IF EXISTS ONLY public.supervision_lines DROP CONSTRAINT IF EXISTS "supervision_lines_supervisorAssignmentId_superviseeAssignme_key";
ALTER TABLE IF EXISTS ONLY public.supervision_lines DROP CONSTRAINT IF EXISTS supervision_lines_pkey;
...
ALTER TABLE IF EXISTS ONLY public.subsidiary_account_provisioning_failures DROP CONSTRAINT IF EXISTS subsidiary_account_provisioning_failures_pkey;
...
ALTER TABLE IF EXISTS ONLY public.print_template_assignments DROP CONSTRAINT IF EXISTS print_template_assignments_pkey;
ALTER TABLE IF EXISTS ONLY public.print_reprint_requests DROP CONSTRAINT IF EXISTS print_reprint_requests_pkey;
ALTER TABLE IF EXISTS ONLY public.print_jobs DROP CONSTRAINT IF EXISTS print_jobs_pkey;
ALTER TABLE IF EXISTS ONLY public.print_jobs DROP CONSTRAINT IF EXISTS "print_jobs_jobId_key";
ALTER TABLE IF EXISTS ONLY public.pricing_rules DROP CONSTRAINT IF EXISTS pricing_rules_pkey;
ALTER TABLE IF EXISTS ONLY public.pricing_rule_applications DROP CONSTRAINT IF EXISTS pricing_rule_applications_pkey;
ALTER TABLE IF EXISTS ONLY public.pricing_conditions DROP CONSTRAINT IF EXISTS pricing_conditions_pkey;
ALTER TABLE IF EXISTS ONLY public.pricing_actions DROP CONSTRAINT IF EXISTS "pricing_actions_ruleId_key";
ALTER TABLE IF EXISTS ONLY public.pricing_actions DROP CONSTRAINT IF EXISTS pricing_actions_pkey;
ALTER TABLE IF EXISTS ONLY public.positions DROP CONSTRAINT IF EXISTS positions_pkey;
ALTER TABLE IF EXISTS ONLY public.positions DROP CONSTRAINT IF EXISTS "positions_companyId_positionKey_key";
...
ALTER TABLE IF EXISTS ONLY public.pbx_extensions DROP CONSTRAINT IF EXISTS pbx_extensions_company_ext_unique;
ALTER TABLE IF EXISTS ONLY public.pbx_calls DROP CONSTRAINT IF EXISTS pbx_calls_pkey;
ALTER TABLE IF EXISTS ONLY public.pbx_call_transcripts DROP CONSTRAINT IF EXISTS pbx_call_transcripts_pkey;
ALTER TABLE IF EXISTS ONLY public.pbx_call_transcripts DROP CONSTRAINT IF EXISTS pbx_call_transcripts_call_unique;
ALTER TABLE IF EXISTS ONLY public.pbx_call_recordings DROP CONSTRAINT IF EXISTS pbx_call_recordings_pkey;
ALTER TABLE IF EXISTS ONLY public.pbx_call_recordings DROP CONSTRAINT IF EXISTS pbx_call_recordings_call_unique;
...
ALTER TABLE IF EXISTS ONLY public.message_read_state DROP CONSTRAINT IF EXISTS message_read_state_pkey;
...
ALTER TABLE IF EXISTS ONLY public.ivr_menus DROP CONSTRAINT IF EXISTS ivr_menus_pkey;
ALTER TABLE IF EXISTS ONLY public.ivr_menus DROP CONSTRAINT IF EXISTS ivr_menus_company_slug_unique;
ALTER TABLE IF EXISTS ONLY public.ivr_menu_options DROP CONSTRAINT IF EXISTS ivr_menu_options_pkey;
ALTER TABLE IF EXISTS ONLY public.ivr_menu_options DROP CONSTRAINT IF EXISTS ivr_menu_options_menu_key_unique;
...
ALTER TABLE IF EXISTS ONLY public.inventory_count_items DROP CONSTRAINT IF EXISTS inventory_count_items_count_product_unique;
...
ALTER TABLE IF EXISTS ONLY public.idempotency_keys DROP CONSTRAINT IF EXISTS idempotency_keys_unique;
...
ALTER TABLE IF EXISTS public.fleet_rental_contracts DROP CONSTRAINT IF EXISTS fleet_rental_contracts_return_fuel_range_check;
ALTER TABLE IF EXISTS ONLY public.fleet_rental_contracts DROP CONSTRAINT IF EXISTS fleet_rental_contracts_pkey;
ALTER TABLE IF EXISTS public.fleet_rental_contracts DROP CONSTRAINT IF EXISTS fleet_rental_contracts_handover_fuel_range_check;
...
ALTER TABLE IF EXISTS ONLY public.field_tracking_points DROP CONSTRAINT IF EXISTS field_tracking_points_pkey;
...
ALTER TABLE IF EXISTS ONLY public.employee_team_memberships DROP CONSTRAINT IF EXISTS employee_team_memberships_pkey;
ALTER TABLE IF EXISTS ONLY public.employee_team_memberships DROP CONSTRAINT IF EXISTS "employee_team_memberships_assignmentId_teamId_key";
ALTER TABLE IF EXISTS ONLY public.employee_signals DROP CONSTRAINT IF EXISTS employee_signals_pkey;
ALTER TABLE IF EXISTS ONLY public.employee_signals DROP CONSTRAINT IF EXISTS "employee_signals_assignmentId_signalType_scope_periodKey_key";
ALTER TABLE IF EXISTS ONLY public.employee_shift_assignments DROP CONSTRAINT IF EXISTS employee_shift_assignments_pkey;
ALTER TABLE IF EXISTS ONLY public.employee_scores DROP CONSTRAINT IF EXISTS employee_scores_pkey;
ALTER TABLE IF EXISTS ONLY public.employee_scores DROP CONSTRAINT IF EXISTS "employee_scores_assignmentId_scope_periodKey_key";
ALTER TABLE IF EXISTS ONLY public.employee_salary_components DROP CONSTRAINT IF EXISTS employee_salary_components_pkey;
ALTER TABLE IF EXISTS ONLY public.employee_salary_components DROP CONSTRAINT IF EXISTS "employee_salary_components_assignmentId_componentId_key";
ALTER TABLE IF EXISTS ONLY public.employee_project_assignments DROP CONSTRAINT IF EXISTS employee_project_assignments_pkey;
ALTER TABLE IF EXISTS ONLY public.employee_project_assignments DROP CONSTRAINT IF EXISTS "employee_project_assignments_assignmentId_projectId_startDa_key";
...
ALTER TABLE IF EXISTS ONLY public.employee_lifecycle_events DROP CONSTRAINT IF EXISTS employee_lifecycle_events_pkey;
...
ALTER TABLE IF EXISTS ONLY public.employee_committee_memberships DROP CONSTRAINT IF EXISTS employee_committee_memberships_pkey;
ALTER TABLE IF EXISTS ONLY public.employee_committee_memberships DROP CONSTRAINT IF EXISTS "employee_committee_memberships_assignmentId_committeeId_key";
...
ALTER TABLE IF EXISTS ONLY public.employee_categories DROP CONSTRAINT IF EXISTS "employee_categories_companyId_categoryKey_key";
ALTER TABLE IF EXISTS ONLY public.employee_assignments DROP CONSTRAINT IF EXISTS employee_assignments_pkey;
ALTER TABLE IF EXISTS ONLY public.employee_assets DROP CONSTRAINT IF EXISTS employee_assets_pkey;
...
ALTER TABLE IF EXISTS ONLY public.driver_navigation_sessions DROP CONSTRAINT IF EXISTS driver_navigation_sessions_pkey;
...
ALTER TABLE IF EXISTS ONLY public.document_ocr_extractions DROP CONSTRAINT IF EXISTS document_ocr_extractions_pkey;
...
ALTER TABLE IF EXISTS ONLY public.development_units DROP CONSTRAINT IF EXISTS development_units_pkey;
...
ALTER TABLE IF EXISTS ONLY public.communication_providers DROP CONSTRAINT IF EXISTS communication_providers_pkey;
ALTER TABLE IF EXISTS ONLY public.communication_providers DROP CONSTRAINT IF EXISTS communication_providers_channel_slug_unique;
...
ALTER TABLE IF EXISTS ONLY public.cargo_manifest_checkpoints DROP CONSTRAINT IF EXISTS cargo_manifest_checkpoints_pkey;
...
ALTER TABLE IF EXISTS ONLY public.attendance_policies_per_category DROP CONSTRAINT IF EXISTS attendance_policies_per_category_pkey;
ALTER TABLE IF EXISTS ONLY public.attendance_policies_per_category DROP CONSTRAINT IF EXISTS "attendance_policies_per_category_companyId_categoryKey_key";
...
ALTER TABLE IF EXISTS ONLY public.approval_authorities DROP CONSTRAINT IF EXISTS approval_authorities_pkey;
ALTER TABLE IF EXISTS ONLY public.approval_authorities DROP CONSTRAINT IF EXISTS "approval_authorities_assignmentId_featureKey_action_currenc_key";
...
ALTER TABLE IF EXISTS ONLY public.ai_request_logs DROP CONSTRAINT IF EXISTS ai_request_logs_pkey;
ALTER TABLE IF EXISTS ONLY public.ai_providers DROP CONSTRAINT IF EXISTS ai_providers_slug_key;
ALTER TABLE IF EXISTS ONLY public.ai_providers DROP CONSTRAINT IF EXISTS ai_providers_pkey;
ALTER TABLE IF EXISTS ONLY public.ai_prompts DROP CONSTRAINT IF EXISTS ai_prompts_slug_version_unique;
ALTER TABLE IF EXISTS ONLY public.ai_prompts DROP CONSTRAINT IF EXISTS ai_prompts_pkey;
ALTER TABLE IF EXISTS ONLY public.ai_prompt_test_cases DROP CONSTRAINT IF EXISTS ai_prompt_test_cases_pkey;
ALTER TABLE IF EXISTS ONLY public.ai_prompt_reviews DROP CONSTRAINT IF EXISTS ai_prompt_reviews_pkey;
ALTER TABLE IF EXISTS ONLY public.ai_prompt_evaluations DROP CONSTRAINT IF EXISTS ai_prompt_evaluations_pkey;
ALTER TABLE IF EXISTS ONLY public.ai_prompt_evaluation_results DROP CONSTRAINT IF EXISTS ai_prompt_evaluation_results_pkey;
ALTER TABLE IF EXISTS ONLY public.administrations DROP CONSTRAINT IF EXISTS administrations_pkey;
ALTER TABLE IF EXISTS ONLY public.administrations DROP CONSTRAINT IF EXISTS "administrations_companyId_name_key";
...
ALTER TABLE IF EXISTS public.zatca_b2c_pause_events ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.warehouse_cycle_count_plans ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.transport_route_patterns ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.transport_route_estimates ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.transport_itinerary_legs ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.transport_itineraries ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.thread_snoozes ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.supervision_lines ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.subsidiary_accounts ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.subsidiary_account_provisioning_failures ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.scoring_weights_per_company ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.print_template_assignments ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.print_reprint_requests ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.print_jobs ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.pricing_rules ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.pricing_rule_applications ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.pricing_conditions ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.pbx_call_transcripts ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.pbx_call_recordings ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.legal_entities ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.ivr_menus ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.ivr_menu_options ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.field_tracking_points ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.employee_team_memberships ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.employee_signals ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.employee_shift_assignments ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.employee_scores ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.employee_salary_components ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.employee_project_assignments ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.employee_lifecycle_events ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.employee_committee_memberships ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.employee_assets ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.driver_navigation_sessions ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.development_units ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.communication_providers ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.communication_dlp_rules ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.cargo_manifest_checkpoints ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.attendance_policies_per_category ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.approval_authorities ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.ai_providers ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.ai_prompts ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.ai_prompt_test_cases ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.ai_prompt_reviews ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.ai_prompt_evaluations ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.ai_prompt_evaluation_results ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.administrations ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.zatca_b2c_pause_events_id_seq;
DROP TABLE IF EXISTS public.zatca_b2c_pause_events;
DROP SEQUENCE IF EXISTS public.wps_skip_alerts_id_seq;
DROP TABLE IF EXISTS public.wps_skip_alerts;
...
DROP SEQUENCE IF EXISTS public.warehouse_cycle_count_plans_id_seq;
DROP TABLE IF EXISTS public.warehouse_cycle_count_plans;
...
DROP SEQUENCE IF EXISTS public.umrah_transport_pilgrims_id_seq;
DROP TABLE IF EXISTS public.umrah_transport_pilgrims;
...
DROP SEQUENCE IF EXISTS public.transport_route_patterns_id_seq;
DROP TABLE IF EXISTS public.transport_route_patterns;
DROP SEQUENCE IF EXISTS public.transport_route_estimates_id_seq;
...
DROP SEQUENCE IF EXISTS public.transport_itinerary_legs_id_seq;
DROP TABLE IF EXISTS public.transport_itinerary_legs;
DROP SEQUENCE IF EXISTS public.transport_itineraries_id_seq;
...
DROP SEQUENCE IF EXISTS public.thread_snoozes_id_seq;
...
DROP SEQUENCE IF EXISTS public.supervision_lines_id_seq;
DROP TABLE IF EXISTS public.supervision_lines;
DROP SEQUENCE IF EXISTS public.subsidiary_accounts_id_seq;
DROP TABLE IF EXISTS public.subsidiary_accounts;
DROP SEQUENCE IF EXISTS public.subsidiary_account_provisioning_failures_id_seq;
...
DROP SEQUENCE IF EXISTS public.print_template_assignments_id_seq;
DROP TABLE IF EXISTS public.print_template_assignments;
DROP SEQUENCE IF EXISTS public.print_reprint_requests_id_seq;
DROP TABLE IF EXISTS public.print_reprint_requests;
DROP SEQUENCE IF EXISTS public.print_jobs_id_seq;
DROP TABLE IF EXISTS public.print_jobs;
DROP SEQUENCE IF EXISTS public.pricing_rules_id_seq;
DROP TABLE IF EXISTS public.pricing_rules;
DROP SEQUENCE IF EXISTS public.pricing_rule_applications_id_seq;
DROP TABLE IF EXISTS public.pricing_rule_applications;
DROP SEQUENCE IF EXISTS public.pricing_conditions_id_seq;
DROP TABLE IF EXISTS public.pricing_conditions;
DROP SEQUENCE IF EXISTS public.pricing_actions_id_seq;
DROP TABLE IF EXISTS public.pricing_actions;
...
DROP SEQUENCE IF EXISTS public.pbx_extensions_id_seq;
...
DROP SEQUENCE IF EXISTS public.pbx_call_transcripts_id_seq;
DROP TABLE IF EXISTS public.pbx_call_transcripts;
DROP SEQUENCE IF EXISTS public.pbx_call_recordings_id_seq;
...
DROP SEQUENCE IF EXISTS public.legal_entities_id_seq;
...
DROP SEQUENCE IF EXISTS public.ivr_menus_id_seq;
DROP TABLE IF EXISTS public.ivr_menus;
DROP SEQUENCE IF EXISTS public.ivr_menu_options_id_seq;
...
DROP SEQUENCE IF EXISTS public.fx_realized_postings_id_seq;
...
DROP SEQUENCE IF EXISTS public.field_tracking_points_id_seq;
DROP TABLE IF EXISTS public.field_tracking_points;
...
DROP SEQUENCE IF EXISTS public.employee_team_memberships_id_seq;
DROP TABLE IF EXISTS public.employee_team_memberships;
DROP SEQUENCE IF EXISTS public.employee_signals_id_seq;
DROP TABLE IF EXISTS public.employee_signals;
DROP SEQUENCE IF EXISTS public.employee_shift_assignments_id_seq;
DROP TABLE IF EXISTS public.employee_shift_assignments;
DROP SEQUENCE IF EXISTS public.employee_scores_id_seq;
DROP TABLE IF EXISTS public.employee_scores;
DROP SEQUENCE IF EXISTS public.employee_salary_components_id_seq;
DROP TABLE IF EXISTS public.employee_salary_components;
DROP SEQUENCE IF EXISTS public.employee_project_assignments_id_seq;
DROP TABLE IF EXISTS public.employee_project_assignments;
...
DROP SEQUENCE IF EXISTS public.employee_lifecycle_events_id_seq;
DROP TABLE IF EXISTS public.employee_lifecycle_events;
...
DROP SEQUENCE IF EXISTS public.employee_committee_memberships_id_seq;
DROP TABLE IF EXISTS public.employee_committee_memberships;
...
DROP SEQUENCE IF EXISTS public.employee_assets_id_seq;
DROP TABLE IF EXISTS public.employee_assets;
...
DROP SEQUENCE IF EXISTS public.driver_navigation_sessions_id_seq;
...
DROP SEQUENCE IF EXISTS public.document_ocr_extractions_id_seq;
DROP TABLE IF EXISTS public.document_ocr_extractions;
...
DROP SEQUENCE IF EXISTS public.development_units_id_seq;
...
DROP SEQUENCE IF EXISTS public.communication_providers_id_seq;
DROP TABLE IF EXISTS public.communication_providers;
DROP SEQUENCE IF EXISTS public.communication_dlp_rules_id_seq;
...
DROP SEQUENCE IF EXISTS public.cargo_manifest_checkpoints_id_seq;
DROP TABLE IF EXISTS public.cargo_manifest_checkpoints;
...
DROP SEQUENCE IF EXISTS public.attendance_policies_per_category_id_seq;
DROP TABLE IF EXISTS public.attendance_policies_per_category;
...
DROP SEQUENCE IF EXISTS public.approval_authorities_id_seq;
DROP TABLE IF EXISTS public.approval_authorities;
...
DROP SEQUENCE IF EXISTS public.ai_request_logs_id_seq;
DROP TABLE IF EXISTS public.ai_request_logs;
DROP SEQUENCE IF EXISTS public.ai_providers_id_seq;
...
DROP SEQUENCE IF EXISTS public.ai_prompt_test_cases_id_seq;
DROP TABLE IF EXISTS public.ai_prompt_test_cases;
DROP SEQUENCE IF EXISTS public.ai_prompt_reviews_id_seq;
DROP TABLE IF EXISTS public.ai_prompt_reviews;
DROP SEQUENCE IF EXISTS public.ai_prompt_evaluations_id_seq;
DROP TABLE IF EXISTS public.ai_prompt_evaluations;
DROP SEQUENCE IF EXISTS public.ai_prompt_evaluation_results_id_seq;
DROP TABLE IF EXISTS public.ai_prompt_evaluation_results;
DROP SEQUENCE IF EXISTS public.administrations_id_seq;
DROP TABLE IF EXISTS public.administrations;
...
DROP FUNCTION IF EXISTS public.journal_entries_derive_status_axes();
...
--
-- Name: journal_entries_derive_status_axes(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.journal_entries_derive_status_axes() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: accounting_allocation_rules; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: ai_prompt_evaluation_results; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.ai_prompt_evaluation_results (
    id integer NOT NULL,
...
--
-- Name: ai_prompt_evaluation_results_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.ai_prompt_evaluation_results_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: ai_prompt_evaluation_results_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.ai_prompt_evaluation_results_id_seq OWNED BY public.ai_prompt_evaluation_results.id;


--
-- Name: ai_prompt_evaluations; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.ai_prompt_evaluations (
    id integer NOT NULL,
    "promptId" integer NOT NULL,
    "promptSlug" character varying(120) NOT NULL,
    "promptVersion" integer NOT NULL,
    "runByUserId" integer,
    "totalCases" integer DEFAULT 0 NOT NULL,
    "passedCases" integer DEFAULT 0 NOT NULL,
    "failedCases" integer DEFAULT 0 NOT NULL,
    "skippedCases" integer DEFAULT 0 NOT NULL,
    "totalCostUsd" numeric(12,6) DEFAULT 0 NOT NULL,
...
--
-- Name: ai_prompt_evaluations_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.ai_prompt_evaluations_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: ai_prompt_evaluations_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.ai_prompt_evaluations_id_seq OWNED BY public.ai_prompt_evaluations.id;


--
-- Name: ai_prompt_reviews; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: ai_prompt_reviews_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.ai_prompt_reviews_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: ai_prompt_reviews_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.ai_prompt_reviews_id_seq OWNED BY public.ai_prompt_reviews.id;


--
-- Name: ai_prompt_test_cases; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.ai_prompt_test_cases (
    id integer NOT NULL,
    "promptSlug" character varying(120) NOT NULL,
...
--
-- Name: ai_prompt_test_cases_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.ai_prompt_test_cases_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: ai_prompt_test_cases_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.ai_prompt_test_cases_id_seq OWNED BY public.ai_prompt_test_cases.id;
...
CREATE TABLE public.ai_providers (
    ...
    "defaultModel" character varying(120),
...
--
-- Name: ai_request_logs; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.ai_request_logs (
    ...
    "companyId" integer,
    "userId" integer,
    provider character varying(60) DEFAULT 'anthropic'::character varying NOT NULL,
...
--
-- Name: ai_request_logs_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: ai_request_logs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: approval_authorities; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.approval_authorities (
    ...
    "requiresDualControl" boolean DEFAULT false NOT NULL,
...
--
-- Name: approval_authorities_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.approval_authorities_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: approval_authorities_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.approval_authorities_id_seq OWNED BY public.approval_authorities.id;
...
--
-- Name: attendance_policies_per_category; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.attendance_policies_per_category (
    id integer NOT NULL,
    "companyId" integer NOT NULL,
    "categoryKey" character varying(40) NOT NULL,
...
--
-- Name: attendance_policies_per_category_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.attendance_policies_per_category_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: attendance_policies_per_category_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.attendance_policies_per_category_id_seq OWNED BY public.attendance_policies_per_category.id;
...
CREATE TABLE public.audit_logs (
    ...
    resolved_scope character varying(40),
    impersonation_source_user integer
);
...
--
-- Name: cargo_manifest_checkpoints; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cargo_manifest_checkpoints (
    id integer NOT NULL,
    "companyId" integer NOT NULL,
    "manifestId" integer NOT NULL,
    "checkpointType" character varying(32) NOT NULL,
    notes text,
    latitude numeric(10,7),
    longitude numeric(10,7),
    "measuredValue" numeric(12,2),
    "measuredUnit" character varying(16),
    "recordedBy" integer,
    "recordedAt" timestamp with time zone DEFAULT now() NOT NULL,
    "createdAt" timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT cargo_manifest_checkpoints_type_check CHECK ((("checkpointType")::text = ANY ((ARRAY['loading_start'::character varying, 'loading_complete'::character varying, 'weighing'::character varying, 'rest_break'::character varying, 'inspection'::character varying, 'customs'::character varying, 'fueling'::character varying, 'unloading_start'::character varying, 'unloading_complete'::character varying, 'other'::character varying])::text[])))
);


--
-- Name: cargo_manifest_checkpoints_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.cargo_manifest_checkpoints_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: cargo_manifest_checkpoints_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.cargo_manifest_checkpoints_id_seq OWNED BY public.cargo_manifest_checkpoints.id;
...
--
-- Name: communication_dlp_rules; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.communication_dlp_rules (
    id integer NOT NULL,
    "companyId" integer,
    name character varying(200) NOT NULL,
    description text,
    ...
    action character varying(20) DEFAULT 'flag'::character varying NOT NULL,
    replacement character varying(60) DEFAULT '[REDACTED]'::character varying,
...
--
-- Name: communication_dlp_rules_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.communication_dlp_rules_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: communication_dlp_rules_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.communication_dlp_rules_id_seq OWNED BY public.communication_dlp_rules.id;


--
-- Name: communication_providers; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: communication_providers_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: communication_providers_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.companies (
    ...
    CONSTRAINT companies_subscription_status_check CHECK ((("subscriptionStatus")::text = ANY (ARRAY['trial'::text, 'active'::text, 'expired'::text, 'cancelled'::text])))
);
...
--
-- Name: development_units; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.development_units (
    ...
    code character varying(50),
    name character varying(200) NOT NULL,
    area numeric(14,3) DEFAULT 0 NOT NULL,
    status character varying(20) DEFAULT 'under_development'::character varying NOT NULL,
...
--
-- Name: development_units_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.development_units_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: development_units_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.development_units_id_seq OWNED BY public.development_units.id;
...
CREATE TABLE public.document_access_log (
    ...
    "ipAddress" text,
    "userAgent" text,
    CONSTRAINT document_access_log_access_type_check CHECK (("accessType" = ANY (ARRAY['download'::text, 'preview'::text, 'view'::text, 'sign'::text])))
);
...
CREATE TABLE public.document_acls (
    ...
    "expiresAt" timestamp with time zone,
    CONSTRAINT document_acls_permission_check CHECK (((permission)::text = ANY (ARRAY['read'::text, 'write'::text, 'admin'::text]))),
    CONSTRAINT document_acls_principal_check CHECK (((((("userId" IS NOT NULL))::integer + (("roleKey" IS NOT NULL))::integer) + (("departmentId" IS NOT NULL))::integer) = 1))
);
...
--
-- Name: document_ocr_extractions; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.document_ocr_extractions (
    id integer NOT NULL,
    "companyId" integer NOT NULL,
    "documentId" integer NOT NULL,
    "docType" character varying(40) NOT NULL,
    fields jsonb DEFAULT '{}'::jsonb NOT NULL,
    confidence numeric(5,2),
    status character varying(20) DEFAULT 'pending'::character varying NOT NULL,
    "reviewedBy" integer,
    "reviewedAt" timestamp with time zone,
    "appliedTo" character varying(40),
    "appliedToId" integer,
    notes text,
    "createdAt" timestamp with time zone DEFAULT now(),
    "updatedAt" timestamp with time zone DEFAULT now(),
...
--
-- Name: document_ocr_extractions_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.document_ocr_extractions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: document_ocr_extractions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.document_ocr_extractions_id_seq OWNED BY public.document_ocr_extractions.id;
...
CREATE TABLE public.document_templates (
    ...
    "paperSize" character varying(20) DEFAULT 'A4'::character varying,
    mode character varying(10) DEFAULT 'preset'::character varying,
    "presetKey" character varying(40),
    "layoutJson" jsonb,
    "cssOverrides" text,
    "headerOverride" jsonb,
    "footerOverride" jsonb,
    version integer DEFAULT 1,
    "isThermal" boolean DEFAULT false,
    "createdBy" integer
);
...
CREATE TABLE public.documents (
    ...
    "deletedAt" timestamp with time zone,
    "ocrText" text,
    "ocrStatus" character varying(20) DEFAULT 'pending'::character varying,
...
--
-- Name: driver_navigation_sessions; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.driver_navigation_sessions (
    id integer NOT NULL,
    "companyId" integer NOT NULL,
    ...
    provider text DEFAULT 'manual_only'::text NOT NULL,
    "arrivedPickupAt" timestamp with time zone,
    "loadedAt" timestamp with time zone,
    "arrivedDropoffAt" timestamp with time zone,
    "deliveredAt" timestamp with time zone,
    notes text,
    "createdAt" timestamp with time zone DEFAULT now() NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT driver_nav_status_check CHECK ((status = ANY (ARRAY['active'::text, 'arrived_pickup'::text, 'loaded'::text, 'arrived_dropoff'::text, 'delivered'::text, 'ended'::text, 'cancelled'::text])))
);


--
-- Name: driver_navigation_sessions_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.driver_navigation_sessions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: driver_navigation_sessions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.driver_navigation_sessions_id_seq OWNED BY public.driver_navigation_sessions.id;
...
CREATE TABLE public.employee_assets (
    ...
    "assetKey" character varying(120) NOT NULL,
    "assetLabel" character varying(200),
    "serialNumber" character varying(120),
    "warehouseAssetId" integer,
    "assignedAt" date DEFAULT CURRENT_DATE NOT NULL,
    "assignedBy" integer,
    "returnedAt" date,
    "returnedBy" integer,
...
CREATE TABLE public.employee_assignments (
    ...
    "jobTitleId" integer,
    "managerId" integer,
    "categoryKey" character varying(40),
    "positionId" integer,
    "legalEntityId" integer,
    "updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
    "isAccessGrant" boolean DEFAULT false
);
...
CREATE TABLE public.employee_categories (
    ...
    "companyId" integer,
    "categoryKey" character varying(40) NOT NULL,
    "labelAr" character varying(120) NOT NULL,
    "labelEn" character varying(120),
    description text,
    color character varying(20),
    "displayOrder" integer DEFAULT 100,
    "exemptFromAutoDeduction" boolean DEFAULT false NOT NULL,
    "trackingFrequencySeconds" integer DEFAULT 0 NOT NULL,
    "isActive" boolean DEFAULT true NOT NULL,
    "createdAt" timestamp without time zone DEFAULT now(),
    "updatedAt" timestamp without time zone DEFAULT now()
);
...
--
-- Name: employee_committee_memberships; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.employee_committee_memberships (
    id integer NOT NULL,
    "assignmentId" integer NOT NULL,
    "committeeId" integer NOT NULL,
    role character varying(40) DEFAULT 'member'::character varying,
    "isVoting" boolean DEFAULT true NOT NULL,
...
--
-- Name: employee_committee_memberships_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.employee_committee_memberships_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: employee_committee_memberships_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.employee_committee_memberships_id_seq OWNED BY public.employee_committee_memberships.id;
...
CREATE TABLE public.employee_lifecycle_events (
    ...
    "stateBefore" character varying(40),
    "stateAfter" character varying(40),
    reason text,
    "decisionDate" date,
    "effectiveDate" date,
    "documentDate" date,
    "documentRef" character varying(80),
    "actorUserId" integer NOT NULL,
    "activeRoleKey" character varying(60),
    "activeDepartmentId" integer,
    "resolvedScope" character varying(20),
...
--
-- Name: employee_lifecycle_events_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.employee_lifecycle_events_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: employee_lifecycle_events_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.employee_lifecycle_events_id_seq OWNED BY public.employee_lifecycle_events.id;
...
--
-- Name: employee_project_assignments; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.employee_project_assignments (
    ...
    "assignmentId" integer NOT NULL,
    "projectId" integer NOT NULL,
    role character varying(80) DEFAULT 'contributor'::character varying,
    "allocationPercent" numeric(5,2) DEFAULT 100.00 NOT NULL,
    "startDate" date DEFAULT CURRENT_DATE NOT NULL,
    "endDate" date,
    "costCenterId" integer,
    "createdAt" timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT "employee_project_assignments_allocationPercent_check" CHECK ((("allocationPercent" > (0)::numeric) AND ("allocationPercent" <= (100)::numeric)))
);


--
-- Name: employee_project_assignments_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.employee_project_assignments_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: employee_project_assignments_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.employee_project_assignments_id_seq OWNED BY public.employee_project_assignments.id;
...
--
-- Name: employee_salary_components_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: employee_salary_components_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: employee_scores; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.employee_scores (
    ...
    "periodKey" character varying(10) NOT NULL,
    "compositeScore" numeric(5,2) NOT NULL,
    trend smallint DEFAULT 0 NOT NULL,
    "disciplineScore" numeric(5,2) DEFAULT 0 NOT NULL,
    "activityScore" numeric(5,2) DEFAULT 0 NOT NULL,
    "productivityScore" numeric(5,2) DEFAULT 0 NOT NULL,
    "qualityScore" numeric(5,2) DEFAULT 0 NOT NULL,
    "managerScore" numeric(5,2) DEFAULT 0 NOT NULL,
    "developmentScore" numeric(5,2) DEFAULT 0 NOT NULL,
...
--
-- Name: employee_scores_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.employee_scores_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: employee_scores_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.employee_scores_id_seq OWNED BY public.employee_scores.id;
...
--
-- Name: employee_signals; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.employee_signals (
    ...
    "assignmentId" integer NOT NULL,
    "employeeId" integer NOT NULL,
    "signalType" character varying(20) NOT NULL,
...
--
-- Name: employee_signals_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.employee_signals_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: employee_signals_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.employee_signals_id_seq OWNED BY public.employee_signals.id;


--
-- Name: employee_team_memberships; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: employee_team_memberships_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.employee_team_memberships_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: employee_team_memberships_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.employee_team_memberships_id_seq OWNED BY public.employee_team_memberships.id;
...
CREATE TABLE public.employee_violations (
    ...
    "updatedAt" timestamp with time zone DEFAULT now(),
    "excludedByLeave" boolean DEFAULT false,
...
ALTER TABLE public.event_outbox ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.event_outbox_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: field_tracking_points; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.field_tracking_points (
    id bigint NOT NULL,
    "companyId" integer NOT NULL,
    "branchId" integer,
    "assignmentId" integer NOT NULL,
    ...
    source character varying(20) DEFAULT 'mobile'::character varying NOT NULL,
    "taskId" integer,
    "tripId" integer,
    "visitId" integer,
...
--
-- Name: field_tracking_points_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.field_tracking_points_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: field_tracking_points_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.field_tracking_points_id_seq OWNED BY public.field_tracking_points.id;
...
CREATE TABLE public.fleet_ai_alerts (
    ...
    "resolvedAt" timestamp with time zone,
    "resolutionNote" text,
    CONSTRAINT fleet_ai_alerts_category_check CHECK (((category)::text = ANY (ARRAY[('adas'::character varying)::text, ('dms'::character varying)::text, ('bsd'::character varying)::text, ('safety'::character varying)::text, ('other'::character varying)::text]))),
    ...
    CONSTRAINT fleet_ai_alerts_severity_check CHECK (((severity)::text = ANY (ARRAY[('info'::character varying)::text, ('low'::character varying)::text, ('medium'::character varying)::text, ('high'::character varying)::text, ('critical'::character varying)::text]))),
    CONSTRAINT fleet_ai_alerts_status_check CHECK (((status)::text = ANY (ARRAY[('open'::character varying)::text, ('acknowledged'::character varying)::text, ('resolved'::character varying)::text, ('dismissed'::character varying)::text])))
);
...
--
-- Name: fleet_alerts_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: fleet_alerts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.fleet_device_events (
    ...
    CONSTRAINT fleet_device_events_severity_check CHECK (((severity)::text = ANY (ARRAY[('info'::character varying)::text, ('low'::character varying)::text, ('medium'::character varying)::text, ('high'::character varying)::text, ('critical'::character varying)::text])))
);
...
CREATE TABLE public.fleet_device_sync_logs (
    ...
    CONSTRAINT fleet_device_sync_logs_status_check CHECK (((status)::text = ANY (ARRAY[('success'::character varying)::text, ('partial'::character varying)::text, ('failure'::character varying)::text, ('skipped'::character varying)::text])))
);
...
CREATE TABLE public.fleet_drivers (
    ...
    "restHoursRequired" numeric(4,2) DEFAULT 8 NOT NULL,
    "lastDutyEndedAt" timestamp with time zone,
    "nationalId" text,
    "iqamaNumber" text,
...
CREATE TABLE public.fleet_maintenance (
    ...
    "updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
    "supplierId" integer,
    "unregisteredSupplierName" character varying(300),
...
CREATE TABLE public.fleet_media_evidence (
    ...
    "rawPayload" jsonb,
    CONSTRAINT fleet_media_evidence_type_check CHECK ((("mediaType")::text = ANY (ARRAY[('image'::character varying)::text, ('video'::character varying)::text, ('audio'::character varying)::text])))
);
...
CREATE TABLE public.fleet_rental_contracts (
    ...
    "updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
    "deletedAt" timestamp with time zone,
    "withDriver" boolean DEFAULT false NOT NULL,
    "driverId" integer,
    "weeklyRate" numeric(12,2),
    "monthlyRate" numeric(12,2),
    "handoverOdometer" integer,
    "handoverFuelLevel" numeric(4,2),
    "handoverNotes" text,
    "handoverAt" timestamp with time zone,
    "returnOdometer" integer,
    "returnFuelLevel" numeric(4,2),
    "returnNotes" text,
    "returnedAt" timestamp with time zone,
    "actualEndDate" date,
    "overageAmount" numeric(12,2) DEFAULT 0,
    CONSTRAINT fleet_rental_contracts_payment_terms_check CHECK ((("paymentTerms")::text = ANY (ARRAY['daily'::text, 'weekly'::text, 'monthly'::text, 'quarterly'::text, 'one_time'::text]))),
    CONSTRAINT fleet_rental_contracts_status_check CHECK (((status)::text = ANY (ARRAY['draft'::text, 'active'::text, 'completed'::text, 'cancelled'::text])))
);
...
CREATE TABLE public.fleet_rental_payments (
    ...
    "createdAt" timestamp with time zone DEFAULT now() NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT fleet_rental_payments_status_check CHECK (((status)::text = ANY (ARRAY['pending'::text, 'partial'::text, 'paid'::text, 'overdue'::text])))
);
...
CREATE TABLE public.fleet_sensor_readings (
    ...
    CONSTRAINT fleet_sensor_readings_type_check CHECK ((("sensorType")::text = ANY (ARRAY[('fuel_level'::character varying)::text, ('weight'::character varying)::text, ('air_pressure'::character varying)::text, ('pto'::character varying)::text, ('dump_piston'::character varying)::text, ('door'::character varying)::text, ('temperature'::character varying)::text, ('engine_rpm'::character varying)::text, ('battery_voltage'::character varying)::text, ('odometer'::character varying)::text, ('custom'::character varying)::text])))
);
...
CREATE TABLE public.fleet_telematics_devices (
    ...
    "updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
    "deletedAt" timestamp with time zone,
    CONSTRAINT fleet_telematics_devices_status_check CHECK (((status)::text = ANY (ARRAY[('unlinked'::character varying)::text, ('linked'::character varying)::text, ('online'::character varying)::text, ('offline'::character varying)::text, ('error'::character varying)::text, ('decommissioned'::character varying)::text])))
);
...
CREATE TABLE public.fleet_tires (
    ...
    "removalReason" text,
    CONSTRAINT fleet_tires_position_check CHECK ((("position")::text = ANY (ARRAY['front_left'::text, 'front_right'::text, 'rear_left'::text, 'rear_right'::text, 'spare'::text, 'extra'::text]))),
    CONSTRAINT fleet_tires_status_check CHECK (((status)::text = ANY (ARRAY['active'::text, 'rotated'::text, 'replaced'::text, 'discarded'::text])))
);
...
CREATE TABLE public.fleet_vehicles (
    ...
    "operationalPayloadKg" numeric(10,2),
    "validForPassengers" boolean,
    "validForCargo" boolean,
    "operationalPassengerCapacity" numeric(6,1),
    "vehicleServiceTypes" text[],
    CONSTRAINT fleet_vehicles_op_pax_within_seats_check CHECK ((("operationalPassengerCapacity" IS NULL) OR ("seatCount" IS NULL) OR ("operationalPassengerCapacity" <= ("seatCount")::numeric))),
    CONSTRAINT fleet_vehicles_service_types_check CHECK ((("vehicleServiceTypes" IS NULL) OR ((array_length("vehicleServiceTypes", 1) > 0) AND ("vehicleServiceTypes" <@ ARRAY['cargo_load'::text, 'passenger_umrah'::text, 'passenger_general'::text, 'equipment_rental'::text, 'internal_transfer'::text, 'other'::text]))))
);
...
CREATE TABLE public.fleet_video_access_logs (
    ...
    status character varying(20) NOT NULL,
    "errorReason" text,
    CONSTRAINT fleet_video_access_logs_status_check CHECK (((status)::text = ANY (ARRAY[('granted'::character varying)::text, ('denied_token'::character varying)::text, ('denied_expired'::character varying)::text, ('denied_session'::character varying)::text, ('denied_user'::character varying)::text])))
);
...
CREATE TABLE public.fleet_video_channels (
    ...
    "createdAt" timestamp with time zone DEFAULT now() NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT fleet_video_channels_type_check CHECK ((("channelType" IS NULL) OR (("channelType")::text = ANY (ARRAY[('front'::character varying)::text, ('driver'::character varying)::text, ('side_left'::character varying)::text, ('side_right'::character varying)::text, ('rear'::character varying)::text, ('cabin'::character varying)::text, ('other'::character varying)::text]))))
);
...
CREATE TABLE public.fleet_video_sessions (
    ...
    CONSTRAINT fleet_video_sessions_status_check CHECK (((status)::text = ANY (ARRAY[('active'::character varying)::text, ('stopped'::character varying)::text, ('expired'::character varying)::text, ('error'::character varying)::text]))),
    CONSTRAINT fleet_video_sessions_stream_check CHECK ((("streamType")::text = ANY (ARRAY[('rtsp'::character varying)::text, ('hls'::character varying)::text, ('http_flv'::character varying)::text, ('webrtc'::character varying)::text])))
);
...
--
-- Name: fx_realized_postings; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.fx_realized_postings (
    id integer NOT NULL,
    "companyId" integer NOT NULL,
    "invoiceId" integer NOT NULL,
...
--
-- Name: fx_realized_postings_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.fx_realized_postings_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: fx_realized_postings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.fx_realized_postings_id_seq OWNED BY public.fx_realized_postings.id;
...
CREATE TABLE public.hr_exit_requests (
    ...
    "updatedAt" timestamp with time zone DEFAULT now(),
    "deletedAt" timestamp with time zone,
    "outstandingLoans" numeric(12,2) DEFAULT 0,
    "loansClearedAt" timestamp with time zone,
    "settlementJournalId" integer,
    "finalSettlementAmount" numeric(12,2)
);
...
CREATE TABLE public.hr_leave_requests (
    ...
    "deletedAt" timestamp with time zone,
    "updatedAt" timestamp with time zone DEFAULT now(),
    CONSTRAINT chk_hr_leave_requests_status CHECK (((status)::text = ANY (ARRAY['pending'::text, 'stage1_approved'::text, 'approved'::text, 'rejected'::text, 'returned'::text, 'cancelled'::text, 'completed'::text])))
);
...
CREATE TABLE public.invoices (
    ...
    CONSTRAINT chk_invoices_status CHECK (((status)::text = ANY (ARRAY['draft'::text, 'pending_approval'::text, 'approved'::text, 'sent'::text, 'partially_paid'::text, 'paid'::text, 'overdue'::text, 'void'::text, 'rejected'::text, 'cancelled'::text, 'posted'::text, 'partial'::text, 'returned'::text, 'closed'::text, 'amended'::text])))
);
...
--
-- Name: ivr_menu_options; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.ivr_menu_options (
    id integer NOT NULL,
    "menuId" integer NOT NULL,
    "dtmfKey" character varying(2) NOT NULL,
    label character varying(200) NOT NULL,
    action character varying(20) NOT NULL,
    "targetExtension" character varying(20),
...
--
-- Name: ivr_menu_options_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.ivr_menu_options_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: ivr_menu_options_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.ivr_menu_options_id_seq OWNED BY public.ivr_menu_options.id;
...
CREATE TABLE public.ivr_menus (
    ...
    "timeoutSeconds" integer DEFAULT 10 NOT NULL,
    "fallbackAction" character varying(20) DEFAULT 'hangup'::character varying NOT NULL,
    "fallbackTargetExtension" character varying(20),
...
CREATE TABLE public.journal_entries (
    ...
    CONSTRAINT journal_entries_status_check CHECK (((status)::text = ANY (ARRAY['draft'::text, 'posted'::text, 'pending_approval'::text, 'approved'::text, 'rejected'::text, 'returned'::text, 'cancelled'::text, 'reversed'::text])))
);
...
CREATE TABLE public.legal_entities (
    ...
    "nameEn" character varying(200),
    "crNumber" character varying(40),
    "vatNumber" character varying(40),
...
--
-- Name: lot_expiry_alerts; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.lot_expiry_alerts (
    id integer NOT NULL,
    "companyId" integer NOT NULL,
    "lotId" integer NOT NULL,
    "thresholdDays" integer NOT NULL,
    "alertedAt" timestamp with time zone DEFAULT now() NOT NULL,
    "expiryDate" date NOT NULL
);


--
-- Name: lot_expiry_alerts_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.lot_expiry_alerts_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: lot_expiry_alerts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.message_log (
    ...
    "fromAddress" character varying(300),
    "toAddress" character varying(300),
    subject character varying(500),
    body text,
    status character varying(30) DEFAULT 'sent'::character varying NOT NULL,
    folder character varying(30) DEFAULT 'sent'::character varying NOT NULL,
    "isStarred" boolean DEFAULT false NOT NULL,
    "relatedType" character varying(60),
    "relatedId" integer,
    "errorMessage" text,
...
--
-- Name: message_read_state; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.message_referrals (
    ...
    reason text,
    "createdAt" timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT message_referrals_target_type_check CHECK ((("targetType" IS NULL) OR ("targetType" = ANY (ARRAY['task'::text, 'ticket'::text, 'request'::text, 'assignment'::text, 'archive'::text]))))
);
...
CREATE TABLE public.official_letters (
    ...
    "recipientOrg" character varying(300),
    "templateId" integer,
    "sourceRequestType" character varying(50),
...
CREATE TABLE public.outbound_queue (
    ...
    "errorMessage" text,
    metadata jsonb,
    "legacySource" character varying(30) DEFAULT 'outbound_queue'::character varying NOT NULL,
    "legacyId" integer,
    "createdAt" timestamp with time zone DEFAULT now() NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
...
--
-- Name: outbound_queue_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: outbound_queue_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: pbx_call_recordings; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: pbx_call_recordings_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.pbx_call_recordings_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: pbx_call_recordings_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.pbx_call_recordings_id_seq OWNED BY public.pbx_call_recordings.id;


--
-- Name: pbx_call_transcripts; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: pbx_call_transcripts_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.pbx_call_transcripts_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: pbx_call_transcripts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.pbx_call_transcripts_id_seq OWNED BY public.pbx_call_transcripts.id;
...
--
-- Name: pbx_extensions; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.pbx_extensions (
    ...
    "employeeId" integer,
    "departmentId" integer,
    type character varying(20) DEFAULT 'employee'::character varying NOT NULL,
    status character varying(20) DEFAULT 'active'::character varying NOT NULL,
    "ringTimeoutSeconds" integer DEFAULT 30 NOT NULL,
...
--
-- Name: pbx_extensions_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.pbx_extensions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: pbx_extensions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.pbx_extensions_id_seq OWNED BY public.pbx_extensions.id;
...
CREATE TABLE public.positions (
    id integer NOT NULL,
    "companyId" integer,
    "positionKey" character varying(50) NOT NULL,
    "labelAr" character varying(120) NOT NULL,
    "labelEn" character varying(120),
    description text,
...
--
-- Name: pricing_actions_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.pricing_actions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: pricing_actions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.pricing_actions_id_seq OWNED BY public.pricing_actions.id;
...
--
-- Name: pricing_rule_applications; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.pricing_rule_applications (
    id integer NOT NULL,
    "companyId" integer NOT NULL,
    "ruleId" integer,
    "ruleName" text,
    ...
    "discountAmount" numeric(14,4) DEFAULT 0 NOT NULL,
...
--
-- Name: pricing_rule_applications_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.pricing_rule_applications_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: pricing_rule_applications_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.pricing_rule_applications_id_seq OWNED BY public.pricing_rule_applications.id;
...
CREATE TABLE public.pricing_rules (
    ...
    "validTo" date,
    status text DEFAULT 'active'::text NOT NULL,
    "logicOp" text DEFAULT 'AND'::text NOT NULL,
    "createdBy" integer,
    "deletedAt" timestamp without time zone,
    "createdAt" timestamp without time zone DEFAULT now() NOT NULL,
    "updatedAt" timestamp without time zone DEFAULT now() NOT NULL
...
CREATE TABLE public.print_jobs (
    id integer NOT NULL,
    "jobId" uuid DEFAULT gen_random_uuid() NOT NULL,
    "companyId" integer NOT NULL,
    "branchId" integer,
    "userId" integer,
    ...
    "pdfStorageKey" text,
    "pdfBytes" integer,
    status character varying(24) DEFAULT 'rendering'::character varying NOT NULL,
    "approvedBy" integer,
    "approvedAt" timestamp with time zone,
    "errorMessage" text,
...
--
-- Name: print_reprint_requests; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.print_reprint_requests (
    id integer NOT NULL,
    "companyId" integer NOT NULL,
    "branchId" integer,
    "entityType" character varying(60) NOT NULL,
...
--
-- Name: print_reprint_requests_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.print_reprint_requests_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: print_reprint_requests_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.print_reprint_requests_id_seq OWNED BY public.print_reprint_requests.id;


--
-- Name: print_template_assignments; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.print_template_assignments (
    id integer NOT NULL,
    "companyId" integer NOT NULL,
    "branchId" integer,
    "entityType" character varying(60) NOT NULL,
...
--
-- Name: print_template_assignments_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.print_template_assignments_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: print_template_assignments_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.print_template_assignments_id_seq OWNED BY public.print_template_assignments.id;
...
CREATE TABLE public.rental_contracts (
    ...
    CONSTRAINT rental_contracts_contract_source_check CHECK ((("contractSource")::text = ANY (ARRAY[('ejar'::character varying)::text, ('manual'::character varying)::text]))),
    CONSTRAINT rental_contracts_contract_type_check CHECK ((("contractType")::text = ANY (ARRAY[('residential_rent'::character varying)::text, ('commercial_rent'::character varying)::text, ('sale'::character varying)::text, ('management'::character varying)::text, ('residential'::character varying)::text, ('commercial'::character varying)::text, ('ejar_unified'::character varying)::text])))
);
...
CREATE TABLE public.request_types (
    ...
    "correspondenceType" character varying(50),
    "autoApproveForDeptManager" boolean DEFAULT false
);
...
CREATE TABLE public.scoring_weights_per_company (
    id integer NOT NULL,
    "companyId" integer NOT NULL,
    "categoryKey" character varying(40),
    "disciplineWeight" numeric(4,3) DEFAULT 0.200 NOT NULL,
    "activityWeight" numeric(4,3) DEFAULT 0.150 NOT NULL,
    "productivityWeight" numeric(4,3) DEFAULT 0.350 NOT NULL,
    "qualityWeight" numeric(4,3) DEFAULT 0.150 NOT NULL,
    "managerWeight" numeric(4,3) DEFAULT 0.100 NOT NULL,
    "developmentWeight" numeric(4,3) DEFAULT 0.050 NOT NULL,
    "createdAt" timestamp with time zone DEFAULT now() NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT "scoring_weights_per_company_activityWeight_check" CHECK ((("activityWeight" >= (0)::numeric) AND ("activityWeight" <= (1)::numeric))),
    CONSTRAINT "scoring_weights_per_company_developmentWeight_check" CHECK ((("developmentWeight" >= (0)::numeric) AND ("developmentWeight" <= (1)::numeric))),
    CONSTRAINT "scoring_weights_per_company_disciplineWeight_check" CHECK ((("disciplineWeight" >= (0)::numeric) AND ("disciplineWeight" <= (1)::numeric))),
    CONSTRAINT "scoring_weights_per_company_managerWeight_check" CHECK ((("managerWeight" >= (0)::numeric) AND ("managerWeight" <= (1)::numeric))),
    CONSTRAINT "scoring_weights_per_company_productivityWeight_check" CHECK ((("productivityWeight" >= (0)::numeric) AND ("productivityWeight" <= (1)::numeric))),
    CONSTRAINT "scoring_weights_per_company_qualityWeight_check" CHECK ((("qualityWeight" >= (0)::numeric) AND ("qualityWeight" <= (1)::numeric))),
    CONSTRAINT scoring_weights_sum_to_one CHECK ((abs((((((("disciplineWeight" + "activityWeight") + "productivityWeight") + "qualityWeight") + "managerWeight") + "developmentWeight") - (1)::numeric)) < 0.001))
);


--
-- Name: scoring_weights_per_company_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.scoring_weights_per_company_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: scoring_weights_per_company_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.scoring_weights_per_company_id_seq OWNED BY public.scoring_weights_per_company.id;
...
--
-- Name: subsidiary_account_provisioning_failures; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.subsidiary_account_provisioning_failures (
    id integer NOT NULL,
    "companyId" integer NOT NULL,
    "branchId" integer,
    "entityType" character varying(50) NOT NULL,
    ...
    "lastAttemptAt" timestamp with time zone DEFAULT now() NOT NULL
);


--
-- Name: subsidiary_account_provisioning_failures_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.subsidiary_account_provisioning_failures_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: subsidiary_account_provisioning_failures_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.subsidiary_account_provisioning_failures_id_seq OWNED BY public.subsidiary_account_provisioning_failures.id;
...
--
-- Name: supervision_lines; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.supervision_lines (
    id integer NOT NULL,
    "companyId" integer NOT NULL,
    "supervisorAssignmentId" integer NOT NULL,
    "superviseeAssignmentId" integer NOT NULL,
    "lineType" character varying(20) DEFAULT 'administrative'::character varying NOT NULL,
    "scopeType" character varying(20),
    "scopeId" integer,
    "startDate" date DEFAULT CURRENT_DATE NOT NULL,
    "endDate" date,
    "isPrimary" boolean DEFAULT false NOT NULL,
...
--
-- Name: supervision_lines_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.supervision_lines_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: supervision_lines_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.supervision_lines_id_seq OWNED BY public.supervision_lines.id;
...
CREATE TABLE public.suppliers (
    ...
    "totalSpend" numeric DEFAULT 0 NOT NULL,
...
CREATE TABLE public.tasks (
    ...
    "createdBy" integer,
    "updatedAt" timestamp with time zone DEFAULT now(),
    "slaReminderSentAt" timestamp with time zone,
    "slaFinalReminderSentAt" timestamp with time zone
);
...
CREATE TABLE public.teams (
    ...
    "companyId" integer NOT NULL,
    "departmentId" integer,
    "leaderAssignmentId" integer,
    name character varying(200) NOT NULL,
    description text,
    "scopeType" character varying(30) DEFAULT 'department'::character varying,
    "isActive" boolean DEFAULT true NOT NULL,
    "createdAt" timestamp with time zone DEFAULT now() NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT now() NOT NULL
);
...
--
-- Name: thread_snoozes; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.thread_snoozes (
    id bigint NOT NULL,
    "companyId" integer NOT NULL,
    "userId" integer NOT NULL,
    channel character varying(20) NOT NULL,
    "peerAddress" character varying(300) NOT NULL,
    "wakeAt" timestamp with time zone NOT NULL,
    reason character varying(300),
    "snoozedAt" timestamp with time zone DEFAULT now() NOT NULL,
    "wokenAt" timestamp with time zone,
    "cancelledAt" timestamp with time zone,
    CONSTRAINT thread_snoozes_channel_check CHECK (((channel)::text = ANY ((ARRAY['email'::character varying, 'sms'::character varying, 'whatsapp'::character varying, 'pbx'::character varying])::text[]))),
    CONSTRAINT thread_snoozes_check CHECK ((("wokenAt" IS NULL) OR ("cancelledAt" IS NULL)))
);


--
-- Name: thread_snoozes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.thread_snoozes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: thread_snoozes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.thread_snoozes_id_seq OWNED BY public.thread_snoozes.id;
...
CREATE TABLE public.transport_bookings (
    ...
    "vehicleSubstitutionPolicy" text DEFAULT 'equivalent_allowed'::text NOT NULL,
    "allowUpgrade" boolean DEFAULT false NOT NULL,
    "requiredExactVehicleId" integer,
    "requiredExactDriverId" integer,
    "pickupWindowStart" timestamp with time zone,
    "pickupWindowEnd" timestamp with time zone,
    "dropoffWindowStart" timestamp with time zone,
    "dropoffWindowEnd" timestamp with time zone,
    "fixedAppointmentTime" timestamp with time zone,
    "isFlexibleTime" boolean DEFAULT false NOT NULL,
    priority integer DEFAULT 0 NOT NULL,
    "fromLocationKind" text,
    "toLocationKind" text,
    "fromLat" numeric(10,7),
    ...
    CONSTRAINT transport_bookings_substitution_policy_check CHECK (("vehicleSubstitutionPolicy" = ANY (ARRAY['exact_only'::text, 'same_class_only'::text, 'equivalent_allowed'::text, 'upgrade_allowed'::text, 'operator_approval'::text, 'customer_approval'::text])))
);
...
CREATE TABLE public.transport_dispatch_orders (
    ...
    "estimatedUnloadingMinutes" integer,
...
--
-- Name: transport_itineraries; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.transport_itineraries (
    id integer NOT NULL,
    "companyId" integer NOT NULL,
    "branchId" integer,
    ...
    "updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
    "deletedAt" timestamp with time zone,
    CONSTRAINT transport_itin_service_check CHECK (("transportServiceType" = ANY (ARRAY['cargo_load'::text, 'passenger_umrah'::text, 'passenger_general'::text, 'equipment_rental'::text, 'internal_transfer'::text, 'other'::text]))),
    CONSTRAINT transport_itin_status_check CHECK ((status = ANY (ARRAY['draft'::text, 'scheduled'::text, 'in_progress'::text, 'completed'::text, 'cancelled'::text])))
);


--
-- Name: transport_itineraries_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.transport_itineraries_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: transport_itineraries_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.transport_itineraries_id_seq OWNED BY public.transport_itineraries.id;


--
-- Name: transport_itinerary_legs; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.transport_itinerary_legs (
    id integer NOT NULL,
    "companyId" integer NOT NULL,
    "itineraryId" integer NOT NULL,
    "legNumber" integer NOT NULL,
    "legType" text DEFAULT 'transit'::text NOT NULL,
    "originText" text,
    ...
    "createdAt" timestamp with time zone DEFAULT now() NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT transport_leg_status_check CHECK ((status = ANY (ARRAY['pending'::text, 'scheduled'::text, 'assigned'::text, 'in_progress'::text, 'completed'::text, 'cancelled'::text, 'skipped'::text]))),
    CONSTRAINT transport_leg_type_check CHECK (("legType" = ANY (ARRAY['transit'::text, 'pickup'::text, 'dropoff'::text, 'rest'::text, 'fuel'::text, 'inspection'::text, 'custom'::text])))
);


--
-- Name: transport_itinerary_legs_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.transport_itinerary_legs_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: transport_itinerary_legs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.transport_itinerary_legs_id_seq OWNED BY public.transport_itinerary_legs.id;
...
--
-- Name: transport_planning_settings; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.transport_planning_settings (
    "companyId" integer NOT NULL,
    "mapProvider" text DEFAULT 'manual_only'::text NOT NULL,
    "mapProviderApiKey" text,
    "defaultRestHoursRequired" numeric(4,2) DEFAULT 8 NOT NULL,
    "defaultLoadingMinutes" integer DEFAULT 15 NOT NULL,
    "defaultUnloadingMinutes" integer DEFAULT 15 NOT NULL,
    "defaultBufferMinutes" integer DEFAULT 15 NOT NULL,
    "defaultDeadheadKmh" integer DEFAULT 60 NOT NULL,
    "estimateCacheTtlMinutes" integer DEFAULT 1440 NOT NULL,
    "createdAt" timestamp with time zone DEFAULT now() NOT NULL,
    "updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
    "autoMaterialiseEnabled" boolean DEFAULT false NOT NULL,
    "defaultMaxDailyDrivingMinutes" integer DEFAULT 780 NOT NULL,
    "defaultMaxWeeklyDrivingMinutes" integer DEFAULT 3600 NOT NULL,
    "operatingStartTime" time without time zone,
    "operatingEndTime" time without time zone,
    "operatingDaysMask" integer,
    CONSTRAINT transport_operating_window_sane_check CHECK (((("operatingDaysMask" IS NULL) OR (("operatingDaysMask" >= 1) AND ("operatingDaysMask" <= 127))) AND (("operatingStartTime" IS NULL) OR ("operatingEndTime" IS NULL) OR ("operatingStartTime" <> "operatingEndTime")))),
    CONSTRAINT transport_planning_caps_sane_check CHECK ((("defaultMaxDailyDrivingMinutes" > 0) AND ("defaultMaxDailyDrivingMinutes" <= (24 * 60)) AND ("defaultMaxWeeklyDrivingMinutes" > 0) AND ("defaultMaxWeeklyDrivingMinutes" <= ((7 * 24) * 60)) AND ("defaultMaxWeeklyDrivingMinutes" >= "defaultMaxDailyDrivingMinutes"))),
    CONSTRAINT transport_planning_map_provider_check CHECK (("mapProvider" = ANY (ARRAY['manual_only'::text, 'google_maps'::text, 'mapbox'::text, 'here_maps'::text])))
);
...
--
-- Name: transport_route_estimates; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.transport_route_estimates (
    id integer NOT NULL,
    "companyId" integer NOT NULL,
    ...
    "createdAt" timestamp with time zone DEFAULT now() NOT NULL,
    "expiresAt" timestamp with time zone NOT NULL,
    CONSTRAINT transport_route_estimates_provider_check CHECK ((provider = ANY (ARRAY['manual_only'::text, 'google_maps'::text, 'mapbox'::text, 'here_maps'::text])))
);


--
-- Name: transport_route_estimates_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.transport_route_estimates_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: transport_route_estimates_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.transport_route_estimates_id_seq OWNED BY public.transport_route_estimates.id;


--
-- Name: transport_route_patterns; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.transport_route_patterns (
    id integer NOT NULL,
    "companyId" integer NOT NULL,
    "branchId" integer,
    "patternCode" text NOT NULL,
    name text NOT NULL,
    "daysOfWeekMask" smallint DEFAULT 0 NOT NULL,
...
--
-- Name: transport_route_patterns_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.transport_route_patterns_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: transport_route_patterns_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.transport_route_patterns_id_seq OWNED BY public.transport_route_patterns.id;
...
CREATE TABLE public.umrah_hotels (
    ...
    "updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
    "deletedAt" timestamp with time zone,
    CONSTRAINT umrah_hotels_star_rating_check CHECK ((("starRating" IS NULL) OR (("starRating" >= 1) AND ("starRating" <= 7))))
);
...
CREATE TABLE public.umrah_import_batches (
    ...
    "unlinkedAgentCount" integer DEFAULT 0,
    "unlinkedGroupCount" integer DEFAULT 0,
    "unlinkedSubAgentCount" integer DEFAULT 0,
...
CREATE TABLE public.umrah_room_blocks (
    ...
    "updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
    "deletedAt" timestamp with time zone,
    CONSTRAINT umrah_room_blocks_room_type_check CHECK ((("roomType" IS NULL) OR (("roomType")::text = ANY (ARRAY['single'::text, 'double'::text, 'triple'::text, 'quad'::text, 'suite'::text]))))
);
...
CREATE TABLE public.users (
    ...
    "preferredCalendar" text DEFAULT 'hijri'::text NOT NULL,
    "preferredLocale" text DEFAULT 'ar'::text NOT NULL,
    CONSTRAINT users_preferred_calendar_check CHECK (("preferredCalendar" = ANY (ARRAY['hijri'::text, 'gregorian'::text]))),
    CONSTRAINT users_preferred_locale_check CHECK (("preferredLocale" = ANY (ARRAY['ar'::text, 'en'::text])))
);
...
--
-- Name: v_message_log_all; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.v_message_log_all AS
 SELECT id,
    "companyId",
    channel,
    direction,
...
--
-- Name: warehouse_cycle_count_plans; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.warehouse_cycle_count_plans (
    id integer NOT NULL,
    "companyId" integer NOT NULL,
    "warehouseId" integer NOT NULL,
    period text NOT NULL,
    "planType" text DEFAULT 'abc'::text NOT NULL,
    "scheduledCount" integer DEFAULT 0 NOT NULL,
    "createdBy" integer,
    "createdAt" timestamp with time zone DEFAULT now() NOT NULL,
    notes text
);
...
--
-- Name: warehouse_cycle_count_plans_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.warehouse_cycle_count_plans_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: warehouse_cycle_count_plans_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.warehouse_cycle_count_plans_id_seq OWNED BY public.warehouse_cycle_count_plans.id;
...
CREATE TABLE public.warehouse_products (
    ...
    "deletedAt" timestamp with time zone,
    "tracksLots" boolean DEFAULT false NOT NULL,
    "tracksSerials" boolean DEFAULT false NOT NULL,
    "itemType" character varying(30) DEFAULT 'product'::character varying,
    CONSTRAINT chk_warehouse_products_item_type CHECK ((("itemType" IS NULL) OR (("itemType")::text = ANY ((ARRAY['product'::character varying, 'service'::character varying, 'asset'::character varying, 'consumable'::character varying, 'digital'::character varying])::text[]))))
);
...
CREATE TABLE public.warehouses (
    ...
    "updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
    "deletedAt" timestamp with time zone,
    "expiryAlertDays" jsonb DEFAULT '[30, 60, 90]'::jsonb NOT NULL
);
...
--
-- Name: wht_categories; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: wps_skip_alerts; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.wps_skip_alerts (
    id integer NOT NULL,
    "companyId" integer NOT NULL,
    "wpsRunId" integer NOT NULL,
    period text NOT NULL,
...
--
-- Name: wps_skip_alerts_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.wps_skip_alerts_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: wps_skip_alerts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.wps_skip_alerts_id_seq OWNED BY public.wps_skip_alerts.id;


--
-- Name: zatca_b2c_pause_events; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.zatca_b2c_pause_events (
    id integer NOT NULL,
    "companyId" integer NOT NULL,
    "createdAt" timestamp with time zone DEFAULT now() NOT NULL,
    "pauseDate" date DEFAULT CURRENT_DATE NOT NULL,
...
--
-- Name: zatca_b2c_pause_events_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.zatca_b2c_pause_events_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: zatca_b2c_pause_events_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.zatca_b2c_pause_events_id_seq OWNED BY public.zatca_b2c_pause_events.id;
