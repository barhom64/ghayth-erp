...
--
-- Tables added by migrations 067-069 (Umrah extended module).
-- These are added here manually because the live DB has not yet had the
-- migrations applied; once applied, `pnpm db:dump-schema` will overwrite
-- this file with the real dump.
--
